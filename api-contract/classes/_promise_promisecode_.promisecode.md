...
*Defined in [api-contract/src/promise/PromiseCode.ts:13](https://github.com/polkadot-js/api/blob/9e681c066/packages/api-contract/src/promise/PromiseCode.ts#L13)*
