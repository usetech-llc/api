...
*Defined in [api-contract/src/promise/PromiseCode.ts:13](https://github.com/polkadot-js/api/blob/c576c689d/packages/api-contract/src/promise/PromiseCode.ts#L13)*
