...
*Defined in [api-contract/src/promise/PromiseContract.ts:14](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-contract/src/promise/PromiseContract.ts#L14)*
...
*Defined in [api-contract/src/base/Contract.ts:35](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-contract/src/base/Contract.ts#L35)*
...
*Defined in [api-contract/src/base/Contract.ts:37](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-contract/src/base/Contract.ts#L37)*
...
*Defined in [api-contract/src/base/Contract.ts:38](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-contract/src/base/Contract.ts#L38)*
