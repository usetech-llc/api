...
*Defined in [api-contract/src/promise/PromiseContract.ts:14](https://github.com/polkadot-js/api/blob/762b16ea13/packages/api-contract/src/promise/PromiseContract.ts#L14)*
