...
*Defined in [api-contract/src/types.ts:96](https://github.com/polkadot-js/api/blob/d487490ca/packages/api-contract/src/types.ts#L96)*
...
*Defined in [api-contract/src/types.ts:95](https://github.com/polkadot-js/api/blob/d487490ca/packages/api-contract/src/types.ts#L95)*
