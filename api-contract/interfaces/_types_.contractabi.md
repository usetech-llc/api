...
*Defined in [api-contract/src/types.ts:96](https://github.com/polkadot-js/api/blob/6bf0d5eea/packages/api-contract/src/types.ts#L96)*
...
*Defined in [api-contract/src/types.ts:95](https://github.com/polkadot-js/api/blob/6bf0d5eea/packages/api-contract/src/types.ts#L95)*
