...
*Defined in [api-contract/src/types.ts:36](https://github.com/polkadot-js/api/blob/7ef945d15b/packages/api-contract/src/types.ts#L36)*
...
*Defined in [api-contract/src/types.ts:37](https://github.com/polkadot-js/api/blob/7ef945d15b/packages/api-contract/src/types.ts#L37)*
