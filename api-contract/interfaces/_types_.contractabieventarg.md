...
*Defined in [api-contract/src/types.ts:36](https://github.com/polkadot-js/api/blob/3a7059459/packages/api-contract/src/types.ts#L36)*
...
*Defined in [api-contract/src/types.ts:37](https://github.com/polkadot-js/api/blob/3a7059459/packages/api-contract/src/types.ts#L37)*
