...
*Defined in [api-contract/src/types.ts:115](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-contract/src/types.ts#L115)*
...
*Defined in [api-contract/src/types.ts:31](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-contract/src/types.ts#L31)*
...
*Defined in [api-contract/src/types.ts:32](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-contract/src/types.ts#L32)*
