...
*Defined in [api-contract/src/types.ts:64](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-contract/src/types.ts#L64)*
...
*Defined in [api-contract/src/types.ts:65](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-contract/src/types.ts#L65)*
...
*Defined in [api-contract/src/types.ts:66](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-contract/src/types.ts#L66)*
