...
*Defined in [api-contract/src/types.ts:59](https://github.com/polkadot-js/api/blob/51a866fd35/packages/api-contract/src/types.ts#L59)*
...
*Defined in [api-contract/src/types.ts:60](https://github.com/polkadot-js/api/blob/51a866fd35/packages/api-contract/src/types.ts#L60)*
