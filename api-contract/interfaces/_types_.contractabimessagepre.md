...
*Defined in [api-contract/src/types.ts:49](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-contract/src/types.ts#L49)*
...
*Defined in [api-contract/src/types.ts:59](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-contract/src/types.ts#L59)*
...
*Defined in [api-contract/src/types.ts:60](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-contract/src/types.ts#L60)*
