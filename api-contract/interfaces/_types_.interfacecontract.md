...
*Defined in [api-contract/src/types.ts:195](https://github.com/polkadot-js/api/blob/8fb64f77cd/packages/api-contract/src/types.ts#L195)*
...
*Defined in [api-contract/src/types.ts:196](https://github.com/polkadot-js/api/blob/8fb64f77cd/packages/api-contract/src/types.ts#L196)*
