...
*Defined in [packages/api-derive/src/type/ReferendumInfoExtended.ts:21](https://github.com/polkadot-js/api/blob/8fb64f77cd/packages/api-derive/src/type/ReferendumInfoExtended.ts#L21)*
...
*Defined in [packages/api-derive/src/type/ReferendumInfoExtended.ts:34](https://github.com/polkadot-js/api/blob/8fb64f77cd/packages/api-derive/src/type/ReferendumInfoExtended.ts#L34)*
...
*Defined in [packages/api-derive/src/type/ReferendumInfoExtended.ts:41](https://github.com/polkadot-js/api/blob/8fb64f77cd/packages/api-derive/src/type/ReferendumInfoExtended.ts#L41)*
