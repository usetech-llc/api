...
*Defined in [packages/api-derive/src/accounts/indexes.ts:33](https://github.com/polkadot-js/api/blob/8a5a86e8b/packages/api-derive/src/accounts/indexes.ts#L33)*
