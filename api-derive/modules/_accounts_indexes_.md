...
*Defined in [packages/api-derive/src/accounts/indexes.ts:33](https://github.com/polkadot-js/api/blob/f67c435378/packages/api-derive/src/accounts/indexes.ts#L33)*
