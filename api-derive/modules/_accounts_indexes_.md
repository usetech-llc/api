...
*Defined in [packages/api-derive/src/accounts/indexes.ts:33](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-derive/src/accounts/indexes.ts#L33)*
