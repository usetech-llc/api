...
*Defined in [packages/api-derive/src/accounts/indexes.ts:33](https://github.com/polkadot-js/api/blob/0d2896630/packages/api-derive/src/accounts/indexes.ts#L33)*
