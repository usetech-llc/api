...
*Defined in [packages/api-derive/src/accounts/indexes.ts:63](https://github.com/polkadot-js/api/blob/07ed405610/packages/api-derive/src/accounts/indexes.ts#L63)*
