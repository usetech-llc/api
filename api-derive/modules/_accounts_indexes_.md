...
*Defined in [packages/api-derive/src/accounts/indexes.ts:63](https://github.com/polkadot-js/api/blob/52953f248b/packages/api-derive/src/accounts/indexes.ts#L63)*
