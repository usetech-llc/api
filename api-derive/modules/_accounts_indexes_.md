...
*Defined in [packages/api-derive/src/accounts/indexes.ts:33](https://github.com/polkadot-js/api/blob/18c302d2cf/packages/api-derive/src/accounts/indexes.ts#L33)*
