...
*Defined in [packages/api-derive/src/accounts/indexes.ts:63](https://github.com/polkadot-js/api/blob/5e82c97c8a/packages/api-derive/src/accounts/indexes.ts#L63)*
