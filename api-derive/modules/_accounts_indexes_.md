...
*Defined in [packages/api-derive/src/accounts/indexes.ts:33](https://github.com/polkadot-js/api/blob/7de647ec0b/packages/api-derive/src/accounts/indexes.ts#L33)*
