...
*Defined in [packages/api-derive/src/accounts/indexes.ts:33](https://github.com/polkadot-js/api/blob/3a7059459/packages/api-derive/src/accounts/indexes.ts#L33)*
