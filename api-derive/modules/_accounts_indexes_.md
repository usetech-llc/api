...
*Defined in [packages/api-derive/src/accounts/indexes.ts:33](https://github.com/polkadot-js/api/blob/47f135065/packages/api-derive/src/accounts/indexes.ts#L33)*
