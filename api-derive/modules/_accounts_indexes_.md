...
*Defined in [packages/api-derive/src/accounts/indexes.ts:33](https://github.com/polkadot-js/api/blob/7ed1857589/packages/api-derive/src/accounts/indexes.ts#L33)*
