...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:28](https://github.com/polkadot-js/api/blob/854a520517/packages/api-derive/src/accounts/indexToId.ts#L28)*
