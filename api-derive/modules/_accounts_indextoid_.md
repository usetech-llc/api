...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/52953f248b/packages/api-derive/src/accounts/indexToId.ts#L51)*
