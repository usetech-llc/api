...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/5e82c97c8a/packages/api-derive/src/accounts/indexToId.ts#L51)*
