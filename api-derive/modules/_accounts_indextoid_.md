...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:28](https://github.com/polkadot-js/api/blob/3a7059459/packages/api-derive/src/accounts/indexToId.ts#L28)*
