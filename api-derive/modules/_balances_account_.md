...
*Defined in [packages/api-derive/src/balances/account.ts:77](https://github.com/polkadot-js/api/blob/5e82c97c8a/packages/api-derive/src/balances/account.ts#L77)*
