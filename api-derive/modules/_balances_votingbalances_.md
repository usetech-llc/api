...
*Defined in [packages/api-derive/src/balances/votingBalances.ts:13](https://github.com/polkadot-js/api/blob/cba34b4b65/packages/api-derive/src/balances/votingBalances.ts#L13)*
...
▸ (`addresses?`: string | AccountId‹› | AccountIndex‹› | Address‹›[]): *Observable‹DerivedBalances[]›*
