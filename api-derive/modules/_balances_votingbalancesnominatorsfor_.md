...
*Defined in [packages/api-derive/src/balances/votingBalancesNominatorsFor.ts:15](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-derive/src/balances/votingBalancesNominatorsFor.ts#L15)*
