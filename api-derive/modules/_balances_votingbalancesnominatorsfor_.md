...
*Defined in [packages/api-derive/src/balances/votingBalancesNominatorsFor.ts:15](https://github.com/polkadot-js/api/blob/0d2896630/packages/api-derive/src/balances/votingBalancesNominatorsFor.ts#L15)*
