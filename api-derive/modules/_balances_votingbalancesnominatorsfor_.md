...
*Defined in [packages/api-derive/src/balances/votingBalancesNominatorsFor.ts:15](https://github.com/polkadot-js/api/blob/47f135065/packages/api-derive/src/balances/votingBalancesNominatorsFor.ts#L15)*
