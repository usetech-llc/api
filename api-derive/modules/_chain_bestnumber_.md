...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/9d4b0ea56a/packages/api-derive/src/chain/bestNumber.ts#L25)*
