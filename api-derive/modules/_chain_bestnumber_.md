...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/7de647ec0b/packages/api-derive/src/chain/bestNumber.ts#L25)*
