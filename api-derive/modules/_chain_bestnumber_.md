...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/82828d8e09/packages/api-derive/src/chain/bestNumber.ts#L25)*
