...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/01abc030f9/packages/api-derive/src/chain/bestNumber.ts#L25)*
