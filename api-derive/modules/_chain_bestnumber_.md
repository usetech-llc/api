...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/83d780220c/packages/api-derive/src/chain/bestNumber.ts#L25)*
