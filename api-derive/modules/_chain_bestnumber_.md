...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/52953f248b/packages/api-derive/src/chain/bestNumber.ts#L25)*
