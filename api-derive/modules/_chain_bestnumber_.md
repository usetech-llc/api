...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/2de7a3c130/packages/api-derive/src/chain/bestNumber.ts#L25)*
