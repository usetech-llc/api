...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/92129746dc/packages/api-derive/src/chain/bestNumber.ts#L25)*
