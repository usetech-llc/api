...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/20b8cd762d/packages/api-derive/src/chain/bestNumber.ts#L25)*
