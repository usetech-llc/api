...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/00026a173f/packages/api-derive/src/chain/bestNumber.ts#L25)*
