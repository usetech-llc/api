...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/519823bc0e/packages/api-derive/src/chain/bestNumber.ts#L25)*
