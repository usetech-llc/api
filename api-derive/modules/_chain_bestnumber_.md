...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/5e0c0ba91a/packages/api-derive/src/chain/bestNumber.ts#L25)*
