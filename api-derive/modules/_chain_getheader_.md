...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/82828d8e09/packages/api-derive/src/chain/getHeader.ts#L30)*
