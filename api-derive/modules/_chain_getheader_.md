...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/7de647ec0b/packages/api-derive/src/chain/getHeader.ts#L30)*
