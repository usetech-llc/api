...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/9d4b0ea56a/packages/api-derive/src/chain/getHeader.ts#L30)*
