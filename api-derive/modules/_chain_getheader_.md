...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/92129746dc/packages/api-derive/src/chain/getHeader.ts#L30)*
