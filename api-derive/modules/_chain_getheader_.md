...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/8fb64f77cd/packages/api-derive/src/chain/getHeader.ts#L30)*
