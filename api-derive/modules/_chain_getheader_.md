...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/8a5a86e8b/packages/api-derive/src/chain/getHeader.ts#L30)*
