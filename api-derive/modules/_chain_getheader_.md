...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/4c328964d5/packages/api-derive/src/chain/getHeader.ts#L30)*
