...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/774f41e6db/packages/api-derive/src/chain/getHeader.ts#L30)*
