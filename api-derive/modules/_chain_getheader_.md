...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/20b8cd762d/packages/api-derive/src/chain/getHeader.ts#L30)*
