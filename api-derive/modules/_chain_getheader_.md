...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/5e82c97c8a/packages/api-derive/src/chain/getHeader.ts#L30)*
