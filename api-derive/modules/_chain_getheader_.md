...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/3a7059459/packages/api-derive/src/chain/getHeader.ts#L30)*
