...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/9c913fb482/packages/api-derive/src/chain/getHeader.ts#L30)*
