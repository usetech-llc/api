...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/f67c435378/packages/api-derive/src/chain/getHeader.ts#L30)*
