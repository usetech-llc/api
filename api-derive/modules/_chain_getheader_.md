...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/6e535b0502/packages/api-derive/src/chain/getHeader.ts#L30)*
