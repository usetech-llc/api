...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/2de7a3c130/packages/api-derive/src/chain/getHeader.ts#L30)*
