...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/66c8e5b4e8/packages/api-derive/src/chain/getHeader.ts#L30)*
