...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/427f821430/packages/api-derive/src/chain/getHeader.ts#L30)*
