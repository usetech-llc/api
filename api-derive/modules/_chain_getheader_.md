...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-derive/src/chain/getHeader.ts#L30)*
