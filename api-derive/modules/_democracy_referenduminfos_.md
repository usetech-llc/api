...
*Defined in [packages/api-derive/src/democracy/referendumInfos.ts:17](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-derive/src/democracy/referendumInfos.ts#L17)*
