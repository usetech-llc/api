...
*Defined in [packages/api-derive/src/democracy/referendumInfos.ts:17](https://github.com/polkadot-js/api/blob/7de647ec0b/packages/api-derive/src/democracy/referendumInfos.ts#L17)*
