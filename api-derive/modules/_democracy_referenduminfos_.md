...
*Defined in [packages/api-derive/src/democracy/referendumInfos.ts:17](https://github.com/polkadot-js/api/blob/427f821430/packages/api-derive/src/democracy/referendumInfos.ts#L17)*
