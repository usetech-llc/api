...
*Defined in [packages/api-derive/src/democracy/referendums.ts:15](https://github.com/polkadot-js/api/blob/427f821430/packages/api-derive/src/democracy/referendums.ts#L15)*
