...
*Defined in [packages/api-derive/src/democracy/referendums.ts:15](https://github.com/polkadot-js/api/blob/5e82c97c8a/packages/api-derive/src/democracy/referendums.ts#L15)*
