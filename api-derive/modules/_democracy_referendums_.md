...
*Defined in [packages/api-derive/src/democracy/referendums.ts:15](https://github.com/polkadot-js/api/blob/52953f248b/packages/api-derive/src/democracy/referendums.ts#L15)*
