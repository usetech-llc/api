...
*Defined in [packages/api-derive/src/democracy/votes.ts:13](https://github.com/polkadot-js/api/blob/07ed405610/packages/api-derive/src/democracy/votes.ts#L13)*
