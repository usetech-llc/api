...
*Defined in [packages/api-derive/src/elections/approvalsOfAt.ts:34](https://github.com/polkadot-js/api/blob/0d2896630/packages/api-derive/src/elections/approvalsOfAt.ts#L34)*
