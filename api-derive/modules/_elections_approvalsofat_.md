...
*Defined in [packages/api-derive/src/elections/approvalsOfAt.ts:34](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-derive/src/elections/approvalsOfAt.ts#L34)*
