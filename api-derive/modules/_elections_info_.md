...
*Defined in [packages/api-derive/src/elections/info.ts:65](https://github.com/polkadot-js/api/blob/f67c435378/packages/api-derive/src/elections/info.ts#L65)*
