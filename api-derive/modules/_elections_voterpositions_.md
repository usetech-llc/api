...
*Defined in [packages/api-derive/src/elections/voterPositions.ts:56](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-derive/src/elections/voterPositions.ts#L56)*
