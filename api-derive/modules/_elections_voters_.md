...
*Defined in [packages/api-derive/src/elections/voters.ts:40](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-derive/src/elections/voters.ts#L40)*
