...
*Defined in [packages/api-derive/src/elections/voters.ts:40](https://github.com/polkadot-js/api/blob/0d2896630/packages/api-derive/src/elections/voters.ts#L40)*
