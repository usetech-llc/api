...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/aee09c48b9/packages/api-derive/src/parachains/all.ts#L94)*
