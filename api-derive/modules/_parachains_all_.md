...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/d041c0abb2/packages/api-derive/src/parachains/all.ts#L94)*
