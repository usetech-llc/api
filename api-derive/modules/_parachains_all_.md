...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/79ee2ede3d/packages/api-derive/src/parachains/all.ts#L94)*
