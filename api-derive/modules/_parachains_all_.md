...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/1e975c68ee/packages/api-derive/src/parachains/all.ts#L94)*
