...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/07f55af202/packages/api-derive/src/parachains/all.ts#L94)*
