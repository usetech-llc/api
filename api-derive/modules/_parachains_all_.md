...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/b46093e5d3/packages/api-derive/src/parachains/all.ts#L94)*
