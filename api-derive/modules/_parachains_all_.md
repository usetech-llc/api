...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/4a1e504ca2/packages/api-derive/src/parachains/all.ts#L94)*
