...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/9a7e0bf82d/packages/api-derive/src/parachains/all.ts#L94)*
