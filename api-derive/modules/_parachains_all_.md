...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/502e54ce5c/packages/api-derive/src/parachains/all.ts#L94)*
