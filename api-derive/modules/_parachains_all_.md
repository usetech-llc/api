...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/2b8ce1b3b7/packages/api-derive/src/parachains/all.ts#L94)*
