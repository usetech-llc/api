...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/c8af75088a/packages/api-derive/src/parachains/all.ts#L94)*
