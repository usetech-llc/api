...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/bdd1e4c917/packages/api-derive/src/parachains/all.ts#L94)*
