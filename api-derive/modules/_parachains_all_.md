...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/8a152ea4c0/packages/api-derive/src/parachains/all.ts#L94)*
