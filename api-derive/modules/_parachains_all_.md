...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/ee622f3d2b/packages/api-derive/src/parachains/all.ts#L94)*
