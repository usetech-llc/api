...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/a5c8e3c4e1/packages/api-derive/src/parachains/all.ts#L94)*
