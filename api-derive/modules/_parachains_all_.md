...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/c11b0dffc5/packages/api-derive/src/parachains/all.ts#L94)*
