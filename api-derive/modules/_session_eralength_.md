...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/0d2896630/packages/api-derive/src/session/eraLength.ts#L14)*
