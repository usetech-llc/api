...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/72e9474f6f/packages/api-derive/src/session/eraLength.ts#L14)*
