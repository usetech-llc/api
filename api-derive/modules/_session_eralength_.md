...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/8a5a86e8b/packages/api-derive/src/session/eraLength.ts#L14)*
