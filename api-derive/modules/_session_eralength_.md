...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/c4e553ad8/packages/api-derive/src/session/eraLength.ts#L14)*
