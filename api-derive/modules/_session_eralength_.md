...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/502e54ce5c/packages/api-derive/src/session/eraLength.ts#L14)*
