...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/532a252fe/packages/api-derive/src/session/eraLength.ts#L14)*
