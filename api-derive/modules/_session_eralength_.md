...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/1ff029dc11/packages/api-derive/src/session/eraLength.ts#L14)*
