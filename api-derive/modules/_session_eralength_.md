...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/d7eb40caf5/packages/api-derive/src/session/eraLength.ts#L14)*
