...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/ca7edf1593/packages/api-derive/src/session/eraLength.ts#L14)*
