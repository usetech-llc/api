...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/b2c84eb461/packages/api-derive/src/session/eraLength.ts#L14)*
