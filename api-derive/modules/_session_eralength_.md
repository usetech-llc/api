...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/d041c0abb2/packages/api-derive/src/session/eraLength.ts#L14)*
