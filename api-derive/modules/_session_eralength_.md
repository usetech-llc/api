...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/0ed156e5d9/packages/api-derive/src/session/eraLength.ts#L14)*
