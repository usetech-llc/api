...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/b6534d2958/packages/api-derive/src/session/eraLength.ts#L14)*
