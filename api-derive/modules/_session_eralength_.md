...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/1f7b9f7f3/packages/api-derive/src/session/eraLength.ts#L14)*
