...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/6e2ad7789e/packages/api-derive/src/session/eraLength.ts#L14)*
