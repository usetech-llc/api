...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/b7eeb992cd/packages/api-derive/src/session/eraLength.ts#L14)*
