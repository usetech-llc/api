...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/6bf0d5eea/packages/api-derive/src/session/eraLength.ts#L14)*
