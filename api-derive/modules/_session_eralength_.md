...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/a5c8e3c4e1/packages/api-derive/src/session/eraLength.ts#L14)*
