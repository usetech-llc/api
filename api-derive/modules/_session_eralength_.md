...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/b46093e5d3/packages/api-derive/src/session/eraLength.ts#L14)*
