...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/18c302d2cf/packages/api-derive/src/session/eraLength.ts#L14)*
