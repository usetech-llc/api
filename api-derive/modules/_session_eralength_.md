...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-derive/src/session/eraLength.ts#L14)*
