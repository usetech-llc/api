...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/01f3666cc/packages/api-derive/src/session/eraLength.ts#L14)*
