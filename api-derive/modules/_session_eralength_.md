...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/1c327c60d9/packages/api-derive/src/session/eraLength.ts#L14)*
