...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/52ffa175a9/packages/api-derive/src/session/eraLength.ts#L14)*
