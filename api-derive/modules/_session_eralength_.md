...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/dd97e9daee/packages/api-derive/src/session/eraLength.ts#L14)*
