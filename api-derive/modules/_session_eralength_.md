...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/da8ff51615/packages/api-derive/src/session/eraLength.ts#L14)*
