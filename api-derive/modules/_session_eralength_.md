...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/b3d592357f/packages/api-derive/src/session/eraLength.ts#L14)*
