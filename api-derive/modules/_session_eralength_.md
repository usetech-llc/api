...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/0c98593ae/packages/api-derive/src/session/eraLength.ts#L14)*
