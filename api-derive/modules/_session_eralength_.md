...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/92129746dc/packages/api-derive/src/session/eraLength.ts#L14)*
