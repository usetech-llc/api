...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/c8af75088a/packages/api-derive/src/session/eraLength.ts#L14)*
