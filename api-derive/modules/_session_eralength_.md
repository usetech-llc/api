...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/ddd5eab7f/packages/api-derive/src/session/eraLength.ts#L14)*
