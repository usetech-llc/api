...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/3a1f284fa8/packages/api-derive/src/session/eraLength.ts#L14)*
