...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/921e55a82e/packages/api-derive/src/session/eraProgress.ts#L14)*
