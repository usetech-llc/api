...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/a5c8e3c4e1/packages/api-derive/src/session/eraProgress.ts#L14)*
