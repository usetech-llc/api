...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/a339491d07/packages/api-derive/src/session/eraProgress.ts#L14)*
