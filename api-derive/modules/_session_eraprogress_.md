...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/5e0c0ba91a/packages/api-derive/src/session/eraProgress.ts#L14)*
