...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/d4e3e546dc/packages/api-derive/src/session/eraProgress.ts#L14)*
