...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/774f41e6db/packages/api-derive/src/session/eraProgress.ts#L14)*
