...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/23f41a0bab/packages/api-derive/src/session/eraProgress.ts#L14)*
