...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/6bf0d5eea/packages/api-derive/src/session/eraProgress.ts#L14)*
