...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/204cf6769d/packages/api-derive/src/session/eraProgress.ts#L14)*
