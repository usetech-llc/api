...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/382f7d75c/packages/api-derive/src/session/eraProgress.ts#L14)*
