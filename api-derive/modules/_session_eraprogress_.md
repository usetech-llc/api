...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/d487490ca/packages/api-derive/src/session/eraProgress.ts#L14)*
