...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/da8ff51615/packages/api-derive/src/session/eraProgress.ts#L14)*
