...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/fefcc2e0dc/packages/api-derive/src/session/eraProgress.ts#L14)*
