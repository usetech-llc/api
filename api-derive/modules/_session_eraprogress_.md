...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/ad2939cc4f/packages/api-derive/src/session/eraProgress.ts#L14)*
