...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/2de7a3c130/packages/api-derive/src/session/eraProgress.ts#L14)*
