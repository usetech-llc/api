...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/8a152ea4c0/packages/api-derive/src/session/eraProgress.ts#L14)*
