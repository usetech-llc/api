...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/f9a42e47e/packages/api-derive/src/session/eraProgress.ts#L14)*
