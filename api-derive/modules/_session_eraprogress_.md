...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/7fe68857a0/packages/api-derive/src/session/eraProgress.ts#L14)*
