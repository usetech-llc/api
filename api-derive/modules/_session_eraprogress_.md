...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/47d0e68f7d/packages/api-derive/src/session/eraProgress.ts#L14)*
