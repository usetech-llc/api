...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/7221a3637c/packages/api-derive/src/session/eraProgress.ts#L14)*
