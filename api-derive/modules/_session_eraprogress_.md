...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/b7eeb992cd/packages/api-derive/src/session/eraProgress.ts#L14)*
