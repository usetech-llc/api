...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/3a1f284fa8/packages/api-derive/src/session/eraProgress.ts#L14)*
