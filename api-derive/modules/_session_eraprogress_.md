...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/b1a657d68/packages/api-derive/src/session/eraProgress.ts#L14)*
