...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/1ff029dc11/packages/api-derive/src/session/eraProgress.ts#L14)*
