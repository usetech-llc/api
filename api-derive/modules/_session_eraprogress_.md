...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/ad2b1abdc9/packages/api-derive/src/session/eraProgress.ts#L14)*
