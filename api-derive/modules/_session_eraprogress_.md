...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/ffaea83e3e/packages/api-derive/src/session/eraProgress.ts#L14)*
