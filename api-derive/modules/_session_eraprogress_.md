...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/00026a173f/packages/api-derive/src/session/eraProgress.ts#L14)*
