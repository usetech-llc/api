...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-derive/src/session/eraProgress.ts#L14)*
