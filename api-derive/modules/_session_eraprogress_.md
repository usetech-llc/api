...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/1c327c60d9/packages/api-derive/src/session/eraProgress.ts#L14)*
