...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/c1c537a3b5/packages/api-derive/src/session/eraProgress.ts#L14)*
