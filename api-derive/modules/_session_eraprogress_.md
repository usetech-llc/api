...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/601cc62d70/packages/api-derive/src/session/eraProgress.ts#L14)*
