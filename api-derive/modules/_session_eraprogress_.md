...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/1f7b9f7f3/packages/api-derive/src/session/eraProgress.ts#L14)*
