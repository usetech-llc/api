...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/6e535b0502/packages/api-derive/src/session/eraProgress.ts#L14)*
