...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/15158b763c/packages/api-derive/src/session/eraProgress.ts#L14)*
