...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/4a1e504ca2/packages/api-derive/src/session/eraProgress.ts#L14)*
