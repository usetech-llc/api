...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/6e2ad7789e/packages/api-derive/src/session/eraProgress.ts#L14)*
