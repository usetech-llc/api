...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/c04fb9073/packages/api-derive/src/session/eraProgress.ts#L14)*
