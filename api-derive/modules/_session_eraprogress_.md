...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/cf2fbfce26/packages/api-derive/src/session/eraProgress.ts#L14)*
