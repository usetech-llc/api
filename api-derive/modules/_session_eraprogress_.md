...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/c8dd26b0d/packages/api-derive/src/session/eraProgress.ts#L14)*
