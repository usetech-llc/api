...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/26c59f6d6e/packages/api-derive/src/session/eraProgress.ts#L14)*
