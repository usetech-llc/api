...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/7ef945d15b/packages/api-derive/src/session/eraProgress.ts#L14)*
