...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/api-derive/src/session/eraProgress.ts#L14)*
