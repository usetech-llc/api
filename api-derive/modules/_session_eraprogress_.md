...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/bdd1e4c917/packages/api-derive/src/session/eraProgress.ts#L14)*
