...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/5e82c97c8a/packages/api-derive/src/session/eraProgress.ts#L14)*
