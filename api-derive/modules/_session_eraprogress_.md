...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/8a5a86e8b/packages/api-derive/src/session/eraProgress.ts#L14)*
