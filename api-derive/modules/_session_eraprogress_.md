...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/83aca87dac/packages/api-derive/src/session/eraProgress.ts#L14)*
