...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/5c4920db6f/packages/api-derive/src/session/eraProgress.ts#L14)*
