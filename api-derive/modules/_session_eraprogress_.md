...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/8ca194a3d2/packages/api-derive/src/session/eraProgress.ts#L14)*
