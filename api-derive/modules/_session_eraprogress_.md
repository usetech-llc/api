...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/19f87aac4d/packages/api-derive/src/session/eraProgress.ts#L14)*
