...
*Defined in [packages/api-derive/src/session/indexes.ts:15](https://github.com/polkadot-js/api/blob/4a1e504ca2/packages/api-derive/src/session/indexes.ts#L15)*
