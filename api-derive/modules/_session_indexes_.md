...
*Defined in [packages/api-derive/src/session/indexes.ts:15](https://github.com/polkadot-js/api/blob/d487490ca/packages/api-derive/src/session/indexes.ts#L15)*
