...
*Defined in [packages/api-derive/src/session/indexes.ts:15](https://github.com/polkadot-js/api/blob/c4e553ad8/packages/api-derive/src/session/indexes.ts#L15)*
