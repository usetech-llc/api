...
*Defined in [packages/api-derive/src/session/indexes.ts:15](https://github.com/polkadot-js/api/blob/ee622f3d2b/packages/api-derive/src/session/indexes.ts#L15)*
