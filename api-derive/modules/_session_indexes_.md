...
*Defined in [packages/api-derive/src/session/indexes.ts:15](https://github.com/polkadot-js/api/blob/4c328964d5/packages/api-derive/src/session/indexes.ts#L15)*
