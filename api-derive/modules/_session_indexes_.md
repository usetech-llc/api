...
*Defined in [packages/api-derive/src/session/indexes.ts:15](https://github.com/polkadot-js/api/blob/47d0e68f7d/packages/api-derive/src/session/indexes.ts#L15)*
