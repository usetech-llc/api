...
*Defined in [packages/api-derive/src/session/indexes.ts:15](https://github.com/polkadot-js/api/blob/9c50e81ab9/packages/api-derive/src/session/indexes.ts#L15)*
