...
*Defined in [packages/api-derive/src/session/indexes.ts:15](https://github.com/polkadot-js/api/blob/601cc62d70/packages/api-derive/src/session/indexes.ts#L15)*
