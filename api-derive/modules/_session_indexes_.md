...
*Defined in [packages/api-derive/src/session/indexes.ts:15](https://github.com/polkadot-js/api/blob/6e2ad7789e/packages/api-derive/src/session/indexes.ts#L15)*
