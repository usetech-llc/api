...
*Defined in [packages/api-derive/src/session/indexes.ts:15](https://github.com/polkadot-js/api/blob/8ca194a3d2/packages/api-derive/src/session/indexes.ts#L15)*
