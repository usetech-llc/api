...
*Defined in [packages/api-derive/src/session/indexes.ts:15](https://github.com/polkadot-js/api/blob/b1a657d68/packages/api-derive/src/session/indexes.ts#L15)*
