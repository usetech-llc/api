...
*Defined in [packages/api-derive/src/session/indexes.ts:15](https://github.com/polkadot-js/api/blob/26c59f6d6e/packages/api-derive/src/session/indexes.ts#L15)*
