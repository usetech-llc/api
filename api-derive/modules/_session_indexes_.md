...
*Defined in [packages/api-derive/src/session/indexes.ts:15](https://github.com/polkadot-js/api/blob/1c327c60d9/packages/api-derive/src/session/indexes.ts#L15)*
