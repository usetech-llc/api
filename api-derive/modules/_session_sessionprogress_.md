...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/5c4920db6f/packages/api-derive/src/session/sessionProgress.ts#L14)*
