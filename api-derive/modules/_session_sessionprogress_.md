...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/c465252e69/packages/api-derive/src/session/sessionProgress.ts#L14)*
