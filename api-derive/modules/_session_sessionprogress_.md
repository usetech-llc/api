...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/762b16ea13/packages/api-derive/src/session/sessionProgress.ts#L14)*
