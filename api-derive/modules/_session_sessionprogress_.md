...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/191abe4e0/packages/api-derive/src/session/sessionProgress.ts#L14)*
