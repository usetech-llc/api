...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/6bf0d5eea/packages/api-derive/src/session/sessionProgress.ts#L14)*
