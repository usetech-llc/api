...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/1e975c68ee/packages/api-derive/src/session/sessionProgress.ts#L14)*
