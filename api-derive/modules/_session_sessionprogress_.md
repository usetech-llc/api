...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/51a866fd35/packages/api-derive/src/session/sessionProgress.ts#L14)*
