...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/20b8cd762d/packages/api-derive/src/session/sessionProgress.ts#L14)*
