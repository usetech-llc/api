...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/5e0c0ba91a/packages/api-derive/src/session/sessionProgress.ts#L14)*
