...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/774f41e6db/packages/api-derive/src/session/sessionProgress.ts#L14)*
