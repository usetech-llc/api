...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-derive/src/session/sessionProgress.ts#L14)*
