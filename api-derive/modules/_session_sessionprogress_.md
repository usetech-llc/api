...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/beddc3e0a5/packages/api-derive/src/session/sessionProgress.ts#L14)*
