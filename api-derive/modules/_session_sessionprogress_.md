...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/6be25966d8/packages/api-derive/src/session/sessionProgress.ts#L14)*
