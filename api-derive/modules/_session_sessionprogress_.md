...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/ce5c8f7443/packages/api-derive/src/session/sessionProgress.ts#L14)*
