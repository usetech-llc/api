...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/eb5ee9860b/packages/api-derive/src/session/sessionProgress.ts#L14)*
