...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/83aca87dac/packages/api-derive/src/session/sessionProgress.ts#L14)*
