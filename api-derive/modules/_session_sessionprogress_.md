...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/502e54ce5c/packages/api-derive/src/session/sessionProgress.ts#L14)*
