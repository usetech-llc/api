...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/8a152ea4c0/packages/api-derive/src/session/sessionProgress.ts#L14)*
