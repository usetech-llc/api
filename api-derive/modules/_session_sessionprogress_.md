...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/5278138cc3/packages/api-derive/src/session/sessionProgress.ts#L14)*
