...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/6e535b0502/packages/api-derive/src/session/sessionProgress.ts#L14)*
