...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/c4e553ad8/packages/api-derive/src/session/sessionProgress.ts#L14)*
