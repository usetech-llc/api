...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/47d0e68f7d/packages/api-derive/src/session/sessionProgress.ts#L14)*
