...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/79ee2ede3d/packages/api-derive/src/session/sessionProgress.ts#L14)*
