...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/82828d8e09/packages/api-derive/src/session/sessionProgress.ts#L14)*
