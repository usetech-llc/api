...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/921e55a82e/packages/api-derive/src/session/sessionProgress.ts#L14)*
