...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/72e9474f6f/packages/api-derive/src/session/sessionProgress.ts#L14)*
