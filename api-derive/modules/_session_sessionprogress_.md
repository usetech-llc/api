...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/8e5b43bf62/packages/api-derive/src/session/sessionProgress.ts#L14)*
