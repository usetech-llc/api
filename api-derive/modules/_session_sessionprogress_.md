...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/c8af75088a/packages/api-derive/src/session/sessionProgress.ts#L14)*
