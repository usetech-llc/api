...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/77bf33b4e/packages/api-derive/src/session/sessionProgress.ts#L14)*
