...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/ffa60d1cfa/packages/api-derive/src/session/sessionProgress.ts#L14)*
