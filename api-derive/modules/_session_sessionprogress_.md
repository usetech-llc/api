...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/ffaea83e3e/packages/api-derive/src/session/sessionProgress.ts#L14)*
