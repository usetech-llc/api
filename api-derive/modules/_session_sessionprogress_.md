...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/9e29e89baf/packages/api-derive/src/session/sessionProgress.ts#L14)*
