...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/bd2e690261/packages/api-derive/src/session/sessionProgress.ts#L14)*
