...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/cc4a4607f1/packages/api-derive/src/session/sessionProgress.ts#L14)*
