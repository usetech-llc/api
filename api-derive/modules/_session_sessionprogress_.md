...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/f9a42e47e/packages/api-derive/src/session/sessionProgress.ts#L14)*
