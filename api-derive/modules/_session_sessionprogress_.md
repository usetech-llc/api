...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/b24a1ff350/packages/api-derive/src/session/sessionProgress.ts#L14)*
