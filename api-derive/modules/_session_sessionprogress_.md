...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/ad2939cc4f/packages/api-derive/src/session/sessionProgress.ts#L14)*
