...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/23f41a0bab/packages/api-derive/src/session/sessionProgress.ts#L14)*
