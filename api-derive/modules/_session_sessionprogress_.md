...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/15158b763c/packages/api-derive/src/session/sessionProgress.ts#L14)*
