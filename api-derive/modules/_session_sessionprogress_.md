...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/ddd5eab7f/packages/api-derive/src/session/sessionProgress.ts#L14)*
