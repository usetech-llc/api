...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/4653cc0d8/packages/api-derive/src/session/sessionProgress.ts#L14)*
