...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/a339491d07/packages/api-derive/src/session/sessionProgress.ts#L14)*
