...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/3a7059459/packages/api-derive/src/session/sessionProgress.ts#L14)*
