...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/de853d9cc0/packages/api-derive/src/session/sessionProgress.ts#L14)*
