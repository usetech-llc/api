...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/519823bc0e/packages/api-derive/src/session/sessionProgress.ts#L14)*
