...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/7b9a11ac25/packages/api-derive/src/session/sessionProgress.ts#L14)*
