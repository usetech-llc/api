...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/30f5baa906/packages/api-derive/src/session/sessionProgress.ts#L14)*
