...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/8b518a909b/packages/api-derive/src/session/sessionProgress.ts#L14)*
