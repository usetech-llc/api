...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/64a4bb2e1/packages/api-derive/src/session/sessionProgress.ts#L14)*
