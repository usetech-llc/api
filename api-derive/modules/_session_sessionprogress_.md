...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/8fb64f77cd/packages/api-derive/src/session/sessionProgress.ts#L14)*
