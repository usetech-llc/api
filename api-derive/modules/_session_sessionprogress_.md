...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/b46093e5d3/packages/api-derive/src/session/sessionProgress.ts#L14)*
