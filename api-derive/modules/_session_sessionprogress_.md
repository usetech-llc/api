...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/07ca18502b/packages/api-derive/src/session/sessionProgress.ts#L14)*
