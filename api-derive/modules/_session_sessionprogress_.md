...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/69dae84a42/packages/api-derive/src/session/sessionProgress.ts#L14)*
