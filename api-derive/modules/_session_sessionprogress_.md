...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/0c98593ae/packages/api-derive/src/session/sessionProgress.ts#L14)*
