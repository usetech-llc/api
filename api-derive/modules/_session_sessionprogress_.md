...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/8a5a86e8b/packages/api-derive/src/session/sessionProgress.ts#L14)*
