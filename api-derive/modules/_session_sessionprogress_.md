...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/d8141198e1/packages/api-derive/src/session/sessionProgress.ts#L14)*
