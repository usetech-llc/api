...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/26c59f6d6e/packages/api-derive/src/session/sessionProgress.ts#L14)*
