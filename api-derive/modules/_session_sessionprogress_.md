...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/da8ff51615/packages/api-derive/src/session/sessionProgress.ts#L14)*
