...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/2de7a3c130/packages/api-derive/src/session/sessionProgress.ts#L14)*
