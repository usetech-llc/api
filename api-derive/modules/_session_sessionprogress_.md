...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/e6018f2f75/packages/api-derive/src/session/sessionProgress.ts#L14)*
