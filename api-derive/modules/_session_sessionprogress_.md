...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/2f215fe2de/packages/api-derive/src/session/sessionProgress.ts#L14)*
