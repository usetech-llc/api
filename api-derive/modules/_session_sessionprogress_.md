...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/a9211690be/packages/api-derive/src/session/sessionProgress.ts#L14)*
