...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/5e82c97c8a/packages/api-derive/src/session/sessionProgress.ts#L14)*
