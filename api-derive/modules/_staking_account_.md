...
*Defined in [packages/api-derive/src/staking/account.ts:91](https://github.com/polkadot-js/api/blob/5e82c97c8a/packages/api-derive/src/staking/account.ts#L91)*
