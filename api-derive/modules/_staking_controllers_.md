...
*Defined in [packages/api-derive/src/staking/controllers.ts:20](https://github.com/polkadot-js/api/blob/20b8cd762d/packages/api-derive/src/staking/controllers.ts#L20)*
