...
*Defined in [packages/api-derive/src/staking/controllers.ts:20](https://github.com/polkadot-js/api/blob/8fb64f77cd/packages/api-derive/src/staking/controllers.ts#L20)*
