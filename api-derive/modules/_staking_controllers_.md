...
*Defined in [packages/api-derive/src/staking/controllers.ts:20](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-derive/src/staking/controllers.ts#L20)*
