...
*Defined in [packages/api-derive/src/staking/infoStash.ts:42](https://github.com/polkadot-js/api/blob/18c302d2cf/packages/api-derive/src/staking/infoStash.ts#L42)*
