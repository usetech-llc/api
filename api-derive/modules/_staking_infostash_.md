...
*Defined in [packages/api-derive/src/staking/infoStash.ts:55](https://github.com/polkadot-js/api/blob/47f135065/packages/api-derive/src/staking/infoStash.ts#L55)*
