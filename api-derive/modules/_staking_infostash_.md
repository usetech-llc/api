...
*Defined in [packages/api-derive/src/staking/infoStash.ts:42](https://github.com/polkadot-js/api/blob/7ed1857589/packages/api-derive/src/staking/infoStash.ts#L42)*
