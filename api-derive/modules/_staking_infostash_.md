...
*Defined in [packages/api-derive/src/staking/infoStash.ts:55](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-derive/src/staking/infoStash.ts#L55)*
