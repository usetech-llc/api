...
*Defined in [packages/api-derive/src/staking/infoStash.ts:55](https://github.com/polkadot-js/api/blob/3a7059459/packages/api-derive/src/staking/infoStash.ts#L55)*
