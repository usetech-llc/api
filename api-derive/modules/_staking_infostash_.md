...
*Defined in [packages/api-derive/src/staking/infoStash.ts:55](https://github.com/polkadot-js/api/blob/8a5a86e8b/packages/api-derive/src/staking/infoStash.ts#L55)*
