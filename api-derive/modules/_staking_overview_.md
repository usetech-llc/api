...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/00026a173f/packages/api-derive/src/staking/overview.ts#L17)*
