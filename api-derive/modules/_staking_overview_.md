...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/0e7c508d7f/packages/api-derive/src/staking/overview.ts#L17)*
