...
*Defined in [packages/api-derive/src/staking/overview.ts:18](https://github.com/polkadot-js/api/blob/382f7d75c/packages/api-derive/src/staking/overview.ts#L18)*
