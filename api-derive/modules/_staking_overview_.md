...
*Defined in [packages/api-derive/src/staking/overview.ts:18](https://github.com/polkadot-js/api/blob/8a5a86e8b/packages/api-derive/src/staking/overview.ts#L18)*
