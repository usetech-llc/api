...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/7e25145fbf/packages/api-derive/src/staking/overview.ts#L17)*
