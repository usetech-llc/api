...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/427f821430/packages/api-derive/src/staking/overview.ts#L17)*
