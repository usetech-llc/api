...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/2f215fe2de/packages/api-derive/src/staking/overview.ts#L17)*
