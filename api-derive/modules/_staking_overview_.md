...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/8b518a909b/packages/api-derive/src/staking/overview.ts#L17)*
