...
*Defined in [packages/api-derive/src/staking/overview.ts:18](https://github.com/polkadot-js/api/blob/204cf6769d/packages/api-derive/src/staking/overview.ts#L18)*
