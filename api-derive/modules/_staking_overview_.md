...
*Defined in [packages/api-derive/src/staking/overview.ts:18](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-derive/src/staking/overview.ts#L18)*
