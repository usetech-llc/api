...
*Defined in [packages/api-derive/src/staking/overview.ts:18](https://github.com/polkadot-js/api/blob/07ca18502b/packages/api-derive/src/staking/overview.ts#L18)*
