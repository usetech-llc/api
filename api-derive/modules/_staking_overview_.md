...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/07ed405610/packages/api-derive/src/staking/overview.ts#L17)*
