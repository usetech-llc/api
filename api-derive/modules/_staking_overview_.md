...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/5df22835f6/packages/api-derive/src/staking/overview.ts#L17)*
