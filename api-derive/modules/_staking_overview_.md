...
*Defined in [packages/api-derive/src/staking/overview.ts:18](https://github.com/polkadot-js/api/blob/006c686c1/packages/api-derive/src/staking/overview.ts#L18)*
