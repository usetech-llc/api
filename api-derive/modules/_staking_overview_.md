...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/480c0abda8/packages/api-derive/src/staking/overview.ts#L17)*
