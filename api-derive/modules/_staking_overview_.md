...
*Defined in [packages/api-derive/src/staking/overview.ts:18](https://github.com/polkadot-js/api/blob/774f41e6db/packages/api-derive/src/staking/overview.ts#L18)*
