...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/01abc030f9/packages/api-derive/src/staking/overview.ts#L17)*
