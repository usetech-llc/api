...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/30f5baa906/packages/api-derive/src/staking/overview.ts#L17)*
