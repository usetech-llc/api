...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/83d780220c/packages/api-derive/src/staking/overview.ts#L17)*
