...
*Defined in [packages/api-derive/src/staking/overview.ts:18](https://github.com/polkadot-js/api/blob/47f135065/packages/api-derive/src/staking/overview.ts#L18)*
