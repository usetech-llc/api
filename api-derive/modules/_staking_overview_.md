...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/5e82c97c8a/packages/api-derive/src/staking/overview.ts#L17)*
