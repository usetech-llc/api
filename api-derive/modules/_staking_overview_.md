...
*Defined in [packages/api-derive/src/staking/overview.ts:18](https://github.com/polkadot-js/api/blob/8fb64f77cd/packages/api-derive/src/staking/overview.ts#L18)*
