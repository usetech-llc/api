...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/20b8cd762d/packages/api-derive/src/staking/overview.ts#L17)*
