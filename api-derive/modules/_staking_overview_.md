...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/7de647ec0b/packages/api-derive/src/staking/overview.ts#L17)*
