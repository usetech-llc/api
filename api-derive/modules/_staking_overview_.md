...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/c8af75088a/packages/api-derive/src/staking/overview.ts#L17)*
