...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/2de7a3c130/packages/api-derive/src/staking/overview.ts#L17)*
