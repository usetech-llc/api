...
*Defined in [packages/api-derive/src/staking/recentlyOffline.ts:38](https://github.com/polkadot-js/api/blob/47f135065/packages/api-derive/src/staking/recentlyOffline.ts#L38)*
