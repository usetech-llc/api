...
*Defined in [packages/api-derive/src/staking/recentlyOffline.ts:38](https://github.com/polkadot-js/api/blob/f67c435378/packages/api-derive/src/staking/recentlyOffline.ts#L38)*
