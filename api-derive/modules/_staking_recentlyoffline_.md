...
*Defined in [packages/api-derive/src/staking/recentlyOffline.ts:38](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-derive/src/staking/recentlyOffline.ts#L38)*
