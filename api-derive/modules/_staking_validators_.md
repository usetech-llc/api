...
*Defined in [packages/api-derive/src/staking/validators.ts:18](https://github.com/polkadot-js/api/blob/47f135065/packages/api-derive/src/staking/validators.ts#L18)*
