...
*Defined in [packages/api-derive/src/staking/validators.ts:18](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api-derive/src/staking/validators.ts#L18)*
