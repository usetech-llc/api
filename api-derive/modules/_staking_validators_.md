...
*Defined in [packages/api-derive/src/staking/validators.ts:18](https://github.com/polkadot-js/api/blob/0d2896630/packages/api-derive/src/staking/validators.ts#L18)*
