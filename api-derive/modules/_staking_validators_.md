...
*Defined in [packages/api-derive/src/staking/validators.ts:16](https://github.com/polkadot-js/api/blob/5e82c97c8a/packages/api-derive/src/staking/validators.ts#L16)*
