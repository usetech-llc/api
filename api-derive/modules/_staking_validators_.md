...
*Defined in [packages/api-derive/src/staking/validators.ts:16](https://github.com/polkadot-js/api/blob/18c302d2cf/packages/api-derive/src/staking/validators.ts#L16)*
