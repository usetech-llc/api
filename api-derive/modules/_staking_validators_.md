...
*Defined in [packages/api-derive/src/staking/validators.ts:18](https://github.com/polkadot-js/api/blob/7de647ec0b/packages/api-derive/src/staking/validators.ts#L18)*
