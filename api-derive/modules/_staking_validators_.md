...
*Defined in [packages/api-derive/src/staking/validators.ts:18](https://github.com/polkadot-js/api/blob/f67c435378/packages/api-derive/src/staking/validators.ts#L18)*
