...
*Defined in [api/src/base/Init.ts:24](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api/src/base/Init.ts#L24)*
...
*Defined in [api/src/base/Decorate.ts:136](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api/src/base/Decorate.ts#L136)*
...
*Defined in [api/src/base/Init.ts:51](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api/src/base/Init.ts#L51)*
