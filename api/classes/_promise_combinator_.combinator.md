...
*Defined in [api/src/promise/Combinator.ts:28](https://github.com/polkadot-js/api/blob/47d0e68f7d/packages/api/src/promise/Combinator.ts#L28)*
...
*Defined in [api/src/promise/Combinator.ts:76](https://github.com/polkadot-js/api/blob/47d0e68f7d/packages/api/src/promise/Combinator.ts#L76)*
