...
*Defined in [promise/Combinator.ts:28](https://github.com/polkadot-js/api/blob/7de647ec0b/packages/api/src/promise/Combinator.ts#L28)*
...
*Defined in [promise/Combinator.ts:76](https://github.com/polkadot-js/api/blob/7de647ec0b/packages/api/src/promise/Combinator.ts#L76)*
