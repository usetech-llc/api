...
*Defined in [api/src/types.ts:74](https://github.com/polkadot-js/api/blob/854a520517/packages/api/src/types.ts#L74)*
...
*Defined in [api/src/types.ts:75](https://github.com/polkadot-js/api/blob/854a520517/packages/api/src/types.ts#L75)*
...
*Defined in [api/src/types.ts:76](https://github.com/polkadot-js/api/blob/854a520517/packages/api/src/types.ts#L76)*
...
*Defined in [api/src/types.ts:77](https://github.com/polkadot-js/api/blob/854a520517/packages/api/src/types.ts#L77)*
