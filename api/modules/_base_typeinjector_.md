...
*Defined in [api/src/base/typeInjector.ts:81](https://github.com/polkadot-js/api/blob/191abe4e0/packages/api/src/base/typeInjector.ts#L81)*
...
*Defined in [api/src/base/typeInjector.ts:76](https://github.com/polkadot-js/api/blob/191abe4e0/packages/api/src/base/typeInjector.ts#L76)*
