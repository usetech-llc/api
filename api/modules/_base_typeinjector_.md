...
*Defined in [api/src/base/typeInjector.ts:81](https://github.com/polkadot-js/api/blob/8a5a86e8b/packages/api/src/base/typeInjector.ts#L81)*
...
*Defined in [api/src/base/typeInjector.ts:76](https://github.com/polkadot-js/api/blob/8a5a86e8b/packages/api/src/base/typeInjector.ts#L76)*
