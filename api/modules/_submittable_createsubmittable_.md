...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/00026a173f/packages/api/src/submittable/createSubmittable.ts#L17)*
