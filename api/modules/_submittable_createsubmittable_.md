...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/f67c435378/packages/api/src/submittable/createSubmittable.ts#L17)*
