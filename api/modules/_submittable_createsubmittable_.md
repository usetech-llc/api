...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/9d4b0ea56a/packages/api/src/submittable/createSubmittable.ts#L17)*
