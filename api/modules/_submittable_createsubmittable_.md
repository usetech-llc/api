...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/5df22835f6/packages/api/src/submittable/createSubmittable.ts#L17)*
