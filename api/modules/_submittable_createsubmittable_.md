...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/30f5baa906/packages/api/src/submittable/createSubmittable.ts#L17)*
