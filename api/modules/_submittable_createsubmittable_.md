...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/7e25145fbf/packages/api/src/submittable/createSubmittable.ts#L17)*
