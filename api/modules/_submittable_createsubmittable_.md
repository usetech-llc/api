...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/5e0c0ba91a/packages/api/src/submittable/createSubmittable.ts#L17)*
