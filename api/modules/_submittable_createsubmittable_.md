...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/6e535b0502/packages/api/src/submittable/createSubmittable.ts#L17)*
