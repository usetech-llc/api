...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/8fb64f77cd/packages/api/src/submittable/createSubmittable.ts#L17)*
