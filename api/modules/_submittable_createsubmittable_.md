...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/fbbbcd2612/packages/api/src/submittable/createSubmittable.ts#L17)*
