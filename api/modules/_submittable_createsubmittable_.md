...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/849f519efe/packages/api/src/submittable/createSubmittable.ts#L17)*
