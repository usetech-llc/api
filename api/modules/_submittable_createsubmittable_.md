...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/5e82c97c8a/packages/api/src/submittable/createSubmittable.ts#L17)*
