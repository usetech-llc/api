...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/4aa5693906/packages/api/src/submittable/createSubmittable.ts#L17)*
