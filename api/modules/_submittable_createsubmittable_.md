...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/23f41a0bab/packages/api/src/submittable/createSubmittable.ts#L17)*
