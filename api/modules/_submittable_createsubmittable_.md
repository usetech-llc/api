...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/8a5a86e8b/packages/api/src/submittable/createSubmittable.ts#L17)*
