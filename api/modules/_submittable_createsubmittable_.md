...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/2ac3640900/packages/api/src/submittable/createSubmittable.ts#L17)*
