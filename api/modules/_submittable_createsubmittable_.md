...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/3a7059459/packages/api/src/submittable/createSubmittable.ts#L17)*
