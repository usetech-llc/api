...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/774f41e6db/packages/api/src/submittable/createSubmittable.ts#L17)*
