...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/5278138cc3/packages/api/src/submittable/createSubmittable.ts#L17)*
