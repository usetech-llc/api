...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/07ca18502b/packages/api/src/submittable/createSubmittable.ts#L17)*
