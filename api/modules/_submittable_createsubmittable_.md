...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/82828d8e09/packages/api/src/submittable/createSubmittable.ts#L17)*
