...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/480c0abda8/packages/api/src/submittable/createSubmittable.ts#L17)*
