...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/01a4d6b4a/packages/api/src/submittable/createSubmittable.ts#L17)*
