...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/bd2e690261/packages/api/src/submittable/createSubmittable.ts#L17)*
