...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/758ce567e5/packages/api/src/submittable/createSubmittable.ts#L17)*
