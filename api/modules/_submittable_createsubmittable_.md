...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/382f7d75c/packages/api/src/submittable/createSubmittable.ts#L17)*
