...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/64ff226535/packages/api/src/submittable/createSubmittable.ts#L17)*
