...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/0e7c508d7f/packages/api/src/submittable/createSubmittable.ts#L17)*
