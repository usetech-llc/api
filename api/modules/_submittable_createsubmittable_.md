...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/9e681c066/packages/api/src/submittable/createSubmittable.ts#L17)*
