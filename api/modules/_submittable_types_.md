...
*Defined in [api/src/submittable/types.ts:27](https://github.com/polkadot-js/api/blob/8a5a86e8b/packages/api/src/submittable/types.ts#L27)*
...
*Defined in [api/src/submittable/types.ts:32](https://github.com/polkadot-js/api/blob/8a5a86e8b/packages/api/src/submittable/types.ts#L32)*
