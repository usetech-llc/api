...
*Defined in [api/src/types/storage.ts:16](https://github.com/polkadot-js/api/blob/23f41a0bab/packages/api/src/types/storage.ts#L16)*
...
*Defined in [api/src/types/storage.ts:21](https://github.com/polkadot-js/api/blob/23f41a0bab/packages/api/src/types/storage.ts#L21)*
...
*Defined in [api/src/types/storage.ts:69](https://github.com/polkadot-js/api/blob/23f41a0bab/packages/api/src/types/storage.ts#L69)*
...
*Defined in [api/src/types/storage.ts:57](https://github.com/polkadot-js/api/blob/23f41a0bab/packages/api/src/types/storage.ts#L57)*
