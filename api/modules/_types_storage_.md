...
*Defined in [api/src/types/storage.ts:16](https://github.com/polkadot-js/api/blob/5e82c97c8a/packages/api/src/types/storage.ts#L16)*
...
*Defined in [api/src/types/storage.ts:21](https://github.com/polkadot-js/api/blob/5e82c97c8a/packages/api/src/types/storage.ts#L21)*
...
*Defined in [api/src/types/storage.ts:70](https://github.com/polkadot-js/api/blob/5e82c97c8a/packages/api/src/types/storage.ts#L70)*
...
*Defined in [api/src/types/storage.ts:58](https://github.com/polkadot-js/api/blob/5e82c97c8a/packages/api/src/types/storage.ts#L58)*
