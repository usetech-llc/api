...
*Defined in [api/src/util/decorate.ts:13](https://github.com/polkadot-js/api/blob/d4e3e546dc/packages/api/src/util/decorate.ts#L13)*
...
*Defined in [api/src/util/decorate.ts:46](https://github.com/polkadot-js/api/blob/d4e3e546dc/packages/api/src/util/decorate.ts#L46)*
