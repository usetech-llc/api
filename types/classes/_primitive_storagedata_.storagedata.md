...
* [toHuman](_primitive_storagedata_.storagedata.md#tohuman)
...
\+ **new StorageData**(`registry`: [Registry](../interfaces/_types_registry_.registry.md), `value?`: [AnyU8a](../modules/_types_helpers_.md#anyu8a)): *[StorageData](_primitive_storagedata_.storagedata.md)*
...
*Defined in [packages/types/src/primitive/Bytes.ts:47](https://github.com/polkadot-js/api/blob/30f5baa906/packages/types/src/primitive/Bytes.ts#L47)*
