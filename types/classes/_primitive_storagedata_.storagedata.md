...
\+ **new StorageData**(`registry`: Registry, `value?`: AnyU8a): *[StorageData](_primitive_storagedata_.storagedata.md)*
...
*Defined in [packages/types/src/primitive/Bytes.ts:47](https://github.com/polkadot-js/api/blob/a339491d07/packages/types/src/primitive/Bytes.ts#L47)*
