[Polkadot JS API](../README.md) › [Globals](../globals.md) › ["codec/create/types"](../modules/_codec_create_types_.md) › [MetaTypeDefEnumVariantTupleStruct](_codec_create_types_.metatypedefenumvarianttuplestruct.md)
...
*Defined in [packages/types/src/codec/create/types.ts:108](https://github.com/polkadot-js/api/blob/a9211690be/packages/types/src/codec/create/types.ts#L108)*
...
*Defined in [packages/types/src/codec/create/types.ts:109](https://github.com/polkadot-js/api/blob/a9211690be/packages/types/src/codec/create/types.ts#L109)*
