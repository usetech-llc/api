...
\+ **new RawAuraPreDigest**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[RawAuraPreDigest](_interfaces_aura_types_.rawaurapredigest.md)*
...
*Defined in [packages/types/src/interfaces/aura/types.ts:10](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/aura/types.ts#L10)*
