...
\+ **new RawBabePreDigestPrimary**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[RawBabePreDigestPrimary](_interfaces_babe_types_.rawbabepredigestprimary.md)*
...
*Defined in [packages/types/src/interfaces/babe/types.ts:53](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/babe/types.ts#L53)*
...
*Defined in [packages/types/src/interfaces/babe/types.ts:55](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/babe/types.ts#L55)*
...
*Defined in [packages/types/src/interfaces/babe/types.ts:57](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/babe/types.ts#L57)*
...
*Defined in [packages/types/src/interfaces/babe/types.ts:59](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/babe/types.ts#L59)*
