...
\+ **new RawBabePreDigestSecondaryTo159**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[RawBabePreDigestSecondaryTo159](_interfaces_babe_types_.rawbabepredigestsecondaryto159.md)*
...
*Defined in [packages/types/src/interfaces/babe/types.ts:87](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/babe/types.ts#L87)*
...
*Defined in [packages/types/src/interfaces/babe/types.ts:89](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/babe/types.ts#L89)*
...
*Defined in [packages/types/src/interfaces/babe/types.ts:91](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/babe/types.ts#L91)*
