...
\+ **new VestingSchedule**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[VestingSchedule](_interfaces_balances_types_.vestingschedule.md)*
...
*Defined in [packages/types/src/interfaces/balances/types.ts:22](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/balances/types.ts#L22)*
...
*Defined in [packages/types/src/interfaces/balances/types.ts:24](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/balances/types.ts#L24)*
...
*Defined in [packages/types/src/interfaces/balances/types.ts:26](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/balances/types.ts#L26)*
