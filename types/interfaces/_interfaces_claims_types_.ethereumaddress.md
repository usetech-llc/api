...
*Inherited from [EthereumAddress](_interfaces_claims_types_.ethereumaddress.md).[constructor](_interfaces_claims_types_.ethereumaddress.md#constructor)*

*Overrides [U8aFixed](../classes/_codec_u8afixed_.u8afixed.md).[constructor](../classes/_codec_u8afixed_.u8afixed.md#constructor)*

*Defined in [packages/types/src/primitive/H160.ts:15](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/H160.ts#L15)*
...
*Inherited from [EthereumAddress](_interfaces_claims_types_.ethereumaddress.md).[toRawType](_interfaces_claims_types_.ethereumaddress.md#torawtype)*

*Overrides [U8aFixed](../classes/_codec_u8afixed_.u8afixed.md).[toRawType](../classes/_codec_u8afixed_.u8afixed.md#torawtype)*

*Defined in [packages/types/src/primitive/H160.ts:23](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/H160.ts#L23)*
