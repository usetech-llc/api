...
\+ **new ContractExecResultSuccess**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[ContractExecResultSuccess](_interfaces_contracts_types_.contractexecresultsuccess.md)*
...
*Defined in [packages/types/src/interfaces/contracts/types.ts:57](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/contracts/types.ts#L57)*
...
*Defined in [packages/types/src/interfaces/contracts/types.ts:55](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/contracts/types.ts#L55)*
