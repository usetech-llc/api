...
\+ **new PrefabWasmModule**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[PrefabWasmModule](_interfaces_contracts_types_.prefabwasmmodule.md)*
...
*Defined in [packages/types/src/interfaces/contracts/types.ts:87](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/contracts/types.ts#L87)*
...
*Defined in [packages/types/src/interfaces/contracts/types.ts:89](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/contracts/types.ts#L89)*
...
*Defined in [packages/types/src/interfaces/contracts/types.ts:83](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/contracts/types.ts#L83)*
...
*Defined in [packages/types/src/interfaces/contracts/types.ts:85](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/contracts/types.ts#L85)*
...
*Defined in [packages/types/src/interfaces/contracts/types.ts:81](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/contracts/types.ts#L81)*
