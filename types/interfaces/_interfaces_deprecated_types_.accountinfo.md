...
\+ **new AccountInfo**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[AccountInfo](_interfaces_deprecated_types_.accountinfo.md)*
...
*Defined in [packages/types/src/interfaces/deprecated/types.ts:14](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/deprecated/types.ts#L14)*
...
*Defined in [packages/types/src/interfaces/deprecated/types.ts:12](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/deprecated/types.ts#L12)*
