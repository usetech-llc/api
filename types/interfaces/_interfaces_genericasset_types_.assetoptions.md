...
\+ **new AssetOptions**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[AssetOptions](_interfaces_genericasset_types_.assetoptions.md)*
...
*Defined in [packages/types/src/interfaces/genericAsset/types.ts:10](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/genericAsset/types.ts#L10)*
...
*Defined in [packages/types/src/interfaces/genericAsset/types.ts:12](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/genericAsset/types.ts#L12)*
