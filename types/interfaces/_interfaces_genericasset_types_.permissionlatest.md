...
\+ **new PermissionLatest**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[PermissionLatest](_interfaces_genericasset_types_.permissionlatest.md)*
...
*Inherited from [PermissionLatest](_interfaces_genericasset_types_.permissionlatest.md).[burn](_interfaces_genericasset_types_.permissionlatest.md#burn)*

*Defined in [packages/types/src/interfaces/genericAsset/types.ts:35](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/genericAsset/types.ts#L35)*
...
*Inherited from [PermissionLatest](_interfaces_genericasset_types_.permissionlatest.md).[mint](_interfaces_genericasset_types_.permissionlatest.md#mint)*

*Defined in [packages/types/src/interfaces/genericAsset/types.ts:33](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/genericAsset/types.ts#L33)*
...
*Inherited from [PermissionLatest](_interfaces_genericasset_types_.permissionlatest.md).[update](_interfaces_genericasset_types_.permissionlatest.md#update)*

*Defined in [packages/types/src/interfaces/genericAsset/types.ts:31](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/genericAsset/types.ts#L31)*
