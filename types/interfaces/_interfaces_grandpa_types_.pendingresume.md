...
\+ **new PendingResume**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[PendingResume](_interfaces_grandpa_types_.pendingresume.md)*
...
*Defined in [packages/types/src/interfaces/grandpa/types.ts:35](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/grandpa/types.ts#L35)*
...
*Defined in [packages/types/src/interfaces/grandpa/types.ts:33](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/grandpa/types.ts#L33)*
