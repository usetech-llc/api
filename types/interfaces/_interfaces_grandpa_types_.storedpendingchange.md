...
\+ **new StoredPendingChange**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[StoredPendingChange](_interfaces_grandpa_types_.storedpendingchange.md)*
...
*Defined in [packages/types/src/interfaces/grandpa/types.ts:46](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/grandpa/types.ts#L46)*
...
*Defined in [packages/types/src/interfaces/grandpa/types.ts:48](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/grandpa/types.ts#L48)*
...
*Defined in [packages/types/src/interfaces/grandpa/types.ts:44](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/grandpa/types.ts#L44)*
