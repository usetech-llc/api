...
\+ **new RegistrarInfo**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[RegistrarInfo](_interfaces_identity_types_.registrarinfo.md)*
...
*Defined in [packages/types/src/interfaces/identity/types.ts:60](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/identity/types.ts#L60)*
...
*Defined in [packages/types/src/interfaces/identity/types.ts:62](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/identity/types.ts#L62)*
...
*Defined in [packages/types/src/interfaces/identity/types.ts:64](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/identity/types.ts#L64)*
