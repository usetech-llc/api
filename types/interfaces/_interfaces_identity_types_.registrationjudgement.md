...
* [[RegistrarIndex](_interfaces_identity_types_.registrarindex.md)‹›, [IdentityJudgement](_interfaces_identity_types_.identityjudgement.md)‹›] & [Codec](_types_.codec.md)
