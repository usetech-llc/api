...
\+ **new OpaqueNetworkState**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[OpaqueNetworkState](_interfaces_imonline_types_.opaquenetworkstate.md)*
...
*Defined in [packages/types/src/interfaces/imOnline/types.ts:35](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/imOnline/types.ts#L35)*
...
*Defined in [packages/types/src/interfaces/imOnline/types.ts:33](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/imOnline/types.ts#L33)*
