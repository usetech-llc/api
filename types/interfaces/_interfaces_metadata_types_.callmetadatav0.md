...
\+ **new CallMetadataV0**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[CallMetadataV0](_interfaces_metadata_types_.callmetadatav0.md)*
...
*Defined in [packages/types/src/interfaces/metadata/types.ts:13](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/metadata/types.ts#L13)*
...
*Defined in [packages/types/src/interfaces/metadata/types.ts:11](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/metadata/types.ts#L11)*
