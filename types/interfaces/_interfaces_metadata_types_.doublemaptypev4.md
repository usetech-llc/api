...
\+ **new DoubleMapTypeV4**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[DoubleMapTypeV4](_interfaces_metadata_types_.doublemaptypev4.md)*
...
*Defined in [packages/types/src/interfaces/metadata/types.ts:48](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/metadata/types.ts#L48)*
...
*Defined in [packages/types/src/interfaces/metadata/types.ts:50](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/metadata/types.ts#L50)*
...
*Defined in [packages/types/src/interfaces/metadata/types.ts:52](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/metadata/types.ts#L52)*
...
*Defined in [packages/types/src/interfaces/metadata/types.ts:56](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/metadata/types.ts#L56)*
...
*Defined in [packages/types/src/interfaces/metadata/types.ts:54](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/metadata/types.ts#L54)*
