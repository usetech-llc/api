...
\+ **new ErrorMetadataV10**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[ErrorMetadataV10](_interfaces_metadata_types_.errormetadatav10.md)*
...
*Inherited from [ErrorMetadataV10](_interfaces_metadata_types_.errormetadatav10.md).[documentation](_interfaces_metadata_types_.errormetadatav10.md#documentation)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:96](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L96)*
...
*Inherited from [ErrorMetadataV10](_interfaces_metadata_types_.errormetadatav10.md).[name](_interfaces_metadata_types_.errormetadatav10.md#name)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:94](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L94)*
