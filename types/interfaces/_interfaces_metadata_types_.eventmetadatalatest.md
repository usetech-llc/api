...
\+ **new EventMetadataLatest**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[EventMetadataLatest](_interfaces_metadata_types_.eventmetadatalatest.md)*
...
*Inherited from [EventMetadataLatest](_interfaces_metadata_types_.eventmetadatalatest.md).[args](_interfaces_metadata_types_.eventmetadatalatest.md#args)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:110](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L110)*
...
*Inherited from [EventMetadataLatest](_interfaces_metadata_types_.eventmetadatalatest.md).[documentation](_interfaces_metadata_types_.eventmetadatalatest.md#documentation)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:112](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L112)*
...
*Inherited from [EventMetadataLatest](_interfaces_metadata_types_.eventmetadatalatest.md).[name](_interfaces_metadata_types_.eventmetadatalatest.md#name)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:108](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L108)*
