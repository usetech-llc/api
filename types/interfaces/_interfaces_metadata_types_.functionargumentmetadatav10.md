...
\+ **new FunctionArgumentMetadataV10**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[FunctionArgumentMetadataV10](_interfaces_metadata_types_.functionargumentmetadatav10.md)*
...
*Inherited from [FunctionArgumentMetadataLatest](_interfaces_metadata_types_.functionargumentmetadatalatest.md).[name](_interfaces_metadata_types_.functionargumentmetadatalatest.md#name)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:154](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/metadata/types.ts#L154)*
...
*Inherited from [FunctionArgumentMetadataLatest](_interfaces_metadata_types_.functionargumentmetadatalatest.md).[type](_interfaces_metadata_types_.functionargumentmetadatalatest.md#type)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:156](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/metadata/types.ts#L156)*
