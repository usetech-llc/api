...
\+ **new FunctionArgumentMetadataV9**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[FunctionArgumentMetadataV9](_interfaces_metadata_types_.functionargumentmetadatav9.md)*
