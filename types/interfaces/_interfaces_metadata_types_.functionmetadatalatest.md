...
\+ **new FunctionMetadataLatest**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[FunctionMetadataLatest](_interfaces_metadata_types_.functionmetadatalatest.md)*
...
*Inherited from [FunctionMetadataLatest](_interfaces_metadata_types_.functionmetadatalatest.md).[args](_interfaces_metadata_types_.functionmetadatalatest.md#args)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:212](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L212)*
...
*Inherited from [FunctionMetadataLatest](_interfaces_metadata_types_.functionmetadatalatest.md).[documentation](_interfaces_metadata_types_.functionmetadatalatest.md#documentation)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:214](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L214)*
...
*Inherited from [FunctionMetadataLatest](_interfaces_metadata_types_.functionmetadatalatest.md).[name](_interfaces_metadata_types_.functionmetadatalatest.md#name)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:210](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L210)*
