...
\+ **new MetadataLatest**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[MetadataLatest](_interfaces_metadata_types_.metadatalatest.md)*
...
*Inherited from [MetadataLatest](_interfaces_metadata_types_.metadatalatest.md).[modules](_interfaces_metadata_types_.metadatalatest.md#modules)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:409](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/metadata/types.ts#L409)*
