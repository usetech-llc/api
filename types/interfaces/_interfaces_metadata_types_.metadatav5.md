...
\+ **new MetadataV5**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[MetadataV5](_interfaces_metadata_types_.metadatav5.md)*
...
*Defined in [packages/types/src/interfaces/metadata/types.ts:433](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/metadata/types.ts#L433)*
