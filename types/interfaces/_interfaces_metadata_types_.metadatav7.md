...
\+ **new MetadataV7**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[MetadataV7](_interfaces_metadata_types_.metadatav7.md)*
...
*Defined in [packages/types/src/interfaces/metadata/types.ts:445](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L445)*
