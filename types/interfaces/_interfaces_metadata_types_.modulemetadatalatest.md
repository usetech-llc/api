...
\+ **new ModuleMetadataLatest**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[ModuleMetadataLatest](_interfaces_metadata_types_.modulemetadatalatest.md)*
...
*Inherited from [ModuleMetadataLatest](_interfaces_metadata_types_.modulemetadatalatest.md).[calls](_interfaces_metadata_types_.modulemetadatalatest.md#calls)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:535](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L535)*
...
*Inherited from [ModuleMetadataLatest](_interfaces_metadata_types_.modulemetadatalatest.md).[constants](_interfaces_metadata_types_.modulemetadatalatest.md#constants)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:539](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L539)*
...
*Inherited from [ModuleMetadataLatest](_interfaces_metadata_types_.modulemetadatalatest.md).[errors](_interfaces_metadata_types_.modulemetadatalatest.md#errors)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:541](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L541)*
...
*Inherited from [ModuleMetadataLatest](_interfaces_metadata_types_.modulemetadatalatest.md).[events](_interfaces_metadata_types_.modulemetadatalatest.md#events)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:537](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L537)*
...
*Inherited from [ModuleMetadataLatest](_interfaces_metadata_types_.modulemetadatalatest.md).[name](_interfaces_metadata_types_.modulemetadatalatest.md#name)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:531](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L531)*
...
*Inherited from [ModuleMetadataLatest](_interfaces_metadata_types_.modulemetadatalatest.md).[storage](_interfaces_metadata_types_.modulemetadatalatest.md#storage)*

*Defined in [packages/types/src/interfaces/metadata/types.ts:533](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L533)*
