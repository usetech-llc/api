...
\+ **new OuterEventMetadataV0**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[OuterEventMetadataV0](_interfaces_metadata_types_.outereventmetadatav0.md)*
...
*Defined in [packages/types/src/interfaces/metadata/types.ts:678](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/metadata/types.ts#L678)*
...
*Defined in [packages/types/src/interfaces/metadata/types.ts:676](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/metadata/types.ts#L676)*
