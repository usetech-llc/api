[Polkadot JS API](../README.md) › [Globals](../globals.md) › ["interfaces/metadata/types"](../modules/_interfaces_metadata_types_.md) › [PlainTypeV7](_interfaces_metadata_types_.plaintypev7.md)
...
* [registry](_interfaces_metadata_types_.plaintypev7.md#registry)
...
* [charAt](_interfaces_metadata_types_.plaintypev7.md#charat)
* [charCodeAt](_interfaces_metadata_types_.plaintypev7.md#charcodeat)
* [concat](_interfaces_metadata_types_.plaintypev7.md#concat)
* [eq](_interfaces_metadata_types_.plaintypev7.md#eq)
* [indexOf](_interfaces_metadata_types_.plaintypev7.md#indexof)
* [lastIndexOf](_interfaces_metadata_types_.plaintypev7.md#lastindexof)
* [localeCompare](_interfaces_metadata_types_.plaintypev7.md#localecompare)
* [match](_interfaces_metadata_types_.plaintypev7.md#match)
* [replace](_interfaces_metadata_types_.plaintypev7.md#replace)
* [search](_interfaces_metadata_types_.plaintypev7.md#search)
* [setOverride](_interfaces_metadata_types_.plaintypev7.md#setoverride)
* [slice](_interfaces_metadata_types_.plaintypev7.md#slice)
* [split](_interfaces_metadata_types_.plaintypev7.md#split)
* [substr](_interfaces_metadata_types_.plaintypev7.md#substr)
* [substring](_interfaces_metadata_types_.plaintypev7.md#substring)
* [toHex](_interfaces_metadata_types_.plaintypev7.md#tohex)
* [toJSON](_interfaces_metadata_types_.plaintypev7.md#tojson)
* [toLocaleLowerCase](_interfaces_metadata_types_.plaintypev7.md#tolocalelowercase)
* [toLocaleUpperCase](_interfaces_metadata_types_.plaintypev7.md#tolocaleuppercase)
* [toLowerCase](_interfaces_metadata_types_.plaintypev7.md#tolowercase)
...
* [toUpperCase](_interfaces_metadata_types_.plaintypev7.md#touppercase)
* [trim](_interfaces_metadata_types_.plaintypev7.md#trim)
* [valueOf](_interfaces_metadata_types_.plaintypev7.md#valueof)

## Constructors

###  constructor

\+ **new PlainTypeV7**(`registry`: [Registry](_types_.registry.md), `value`: [Text](../classes/_primitive_text_.text.md) | [Uint8Array](../classes/_codec_raw_.raw.md#static-uint8array) | string): *[PlainTypeV7](_interfaces_metadata_types_.plaintypev7.md)*
...
*Defined in [packages/types/src/primitive/Type.ts:18](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Type.ts#L18)*
...
*Defined in [packages/types/src/primitive/Text.ts:25](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Text.ts#L25)*
...
*Defined in [packages/types/src/primitive/Type.ts:34](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Type.ts#L34)*
...
*Defined in [packages/types/src/primitive/Text.ts:69](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Text.ts#L69)*
...
*Defined in [packages/types/src/primitive/Text.ts:76](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Text.ts#L76)*
...
*Defined in [packages/types/src/primitive/Text.ts:83](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Text.ts#L83)*
...
*Defined in [packages/types/src/primitive/Text.ts:91](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Text.ts#L91)*
...
*Defined in [packages/types/src/primitive/Text.ts:100](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Text.ts#L100)*
...
*Defined in [packages/types/src/primitive/Text.ts:107](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Text.ts#L107)*
...
*Defined in [packages/types/src/primitive/Text.ts:116](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Text.ts#L116)*
...
*Defined in [packages/types/src/primitive/Type.ts:44](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Type.ts#L44)*
...
*Defined in [packages/types/src/primitive/Text.ts:130](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Text.ts#L130)*
...
*Defined in [packages/types/src/primitive/Text.ts:138](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Text.ts#L138)*
