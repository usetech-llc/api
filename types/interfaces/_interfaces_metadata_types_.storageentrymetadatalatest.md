...
\+ **new StorageEntryMetadataLatest**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[StorageEntryMetadataLatest](_interfaces_metadata_types_.storageentrymetadatalatest.md)*
...
*Inherited from [StorageEntryMetadataLatest](_interfaces_metadata_types_.storageentrymetadatalatest.md).[documentation](_interfaces_metadata_types_.storageentrymetadatalatest.md#documentation)*
...
*Inherited from [StorageEntryMetadataLatest](_interfaces_metadata_types_.storageentrymetadatalatest.md).[fallback](_interfaces_metadata_types_.storageentrymetadatalatest.md#fallback)*
...
*Inherited from [StorageEntryMetadataLatest](_interfaces_metadata_types_.storageentrymetadatalatest.md).[modifier](_interfaces_metadata_types_.storageentrymetadatalatest.md#modifier)*
...
*Inherited from [StorageEntryMetadataLatest](_interfaces_metadata_types_.storageentrymetadatalatest.md).[name](_interfaces_metadata_types_.storageentrymetadatalatest.md#name)*
...
*Inherited from [StorageEntryMetadataLatest](_interfaces_metadata_types_.storageentrymetadatalatest.md).[type](_interfaces_metadata_types_.storageentrymetadatalatest.md#type)*
