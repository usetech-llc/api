...
\+ **new StorageMetadataV0**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[StorageMetadataV0](_interfaces_metadata_types_.storagemetadatav0.md)*
...
*Defined in [packages/types/src/interfaces/metadata/types.ts:1069](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L1069)*
...
*Defined in [packages/types/src/interfaces/metadata/types.ts:1067](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L1067)*
