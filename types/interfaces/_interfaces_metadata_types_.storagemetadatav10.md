...
\+ **new StorageMetadataV10**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[StorageMetadataV10](_interfaces_metadata_types_.storagemetadatav10.md)*
...
*Defined in [packages/types/src/interfaces/metadata/types.ts:1077](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L1077)*
...
*Defined in [packages/types/src/interfaces/metadata/types.ts:1075](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/metadata/types.ts#L1075)*
