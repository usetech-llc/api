...
\+ **new OffenceDetails**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[OffenceDetails](_interfaces_offences_types_.offencedetails.md)*
...
*Defined in [packages/types/src/interfaces/offences/types.ts:16](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/offences/types.ts#L16)*
...
*Defined in [packages/types/src/interfaces/offences/types.ts:18](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/offences/types.ts#L18)*
