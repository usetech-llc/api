...
\+ **new AttestedCandidate**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[AttestedCandidate](_interfaces_parachains_types_.attestedcandidate.md)*
...
*Defined in [packages/types/src/interfaces/parachains/types.ts:12](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/parachains/types.ts#L12)*
...
*Defined in [packages/types/src/interfaces/parachains/types.ts:14](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/parachains/types.ts#L14)*
