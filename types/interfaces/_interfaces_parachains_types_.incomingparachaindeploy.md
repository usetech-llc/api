...
\+ **new IncomingParachainDeploy**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[IncomingParachainDeploy](_interfaces_parachains_types_.incomingparachaindeploy.md)*
...
*Defined in [packages/types/src/interfaces/parachains/types.ts:86](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/parachains/types.ts#L86)*
...
*Defined in [packages/types/src/interfaces/parachains/types.ts:88](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/parachains/types.ts#L88)*
