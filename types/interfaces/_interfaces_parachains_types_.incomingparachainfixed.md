...
\+ **new IncomingParachainFixed**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[IncomingParachainFixed](_interfaces_parachains_types_.incomingparachainfixed.md)*
...
*Defined in [packages/types/src/interfaces/parachains/types.ts:94](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/parachains/types.ts#L94)*
...
*Defined in [packages/types/src/interfaces/parachains/types.ts:96](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/parachains/types.ts#L96)*
