...
\+ **new NewBidder**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[NewBidder](_interfaces_parachains_types_.newbidder.md)*
...
*Defined in [packages/types/src/interfaces/parachains/types.ts:110](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/parachains/types.ts#L110)*
...
*Defined in [packages/types/src/interfaces/parachains/types.ts:108](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/parachains/types.ts#L108)*
