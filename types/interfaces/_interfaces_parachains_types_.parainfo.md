...
\+ **new ParaInfo**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[ParaInfo](_interfaces_parachains_types_.parainfo.md)*
...
*Defined in [packages/types/src/interfaces/parachains/types.ts:130](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/parachains/types.ts#L130)*
