...
\+ **new WinningData**(`registry`: [Registry](_types_.registry.md), `Type`: [Constructor](_types_.constructor.md)‹[WinningDataEntry](_interfaces_parachains_types_.winningdataentry.md)› | [InterfaceTypes](../modules/_types_.md#interfacetypes), `value`: [Vec](../classes/_codec_vec_.vec.md)‹any› | [Uint8Array](../classes/_codec_raw_.raw.md#static-uint8array) | string | any[]): *[WinningData](_interfaces_parachains_types_.winningdata.md)*
