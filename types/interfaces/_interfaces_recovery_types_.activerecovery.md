...
\+ **new ActiveRecovery**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[ActiveRecovery](_interfaces_recovery_types_.activerecovery.md)*
...
*Defined in [packages/types/src/interfaces/recovery/types.ts:11](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/recovery/types.ts#L11)*
...
*Defined in [packages/types/src/interfaces/recovery/types.ts:13](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/recovery/types.ts#L13)*
...
*Defined in [packages/types/src/interfaces/recovery/types.ts:15](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/recovery/types.ts#L15)*
