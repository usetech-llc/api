...
\+ **new Health**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[Health](_interfaces_rpc_types_.health.md)*
...
*Defined in [packages/types/src/interfaces/rpc/types.ts:66](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/rpc/types.ts#L66)*
...
*Defined in [packages/types/src/interfaces/rpc/types.ts:64](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/rpc/types.ts#L64)*
...
*Defined in [packages/types/src/interfaces/rpc/types.ts:68](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/rpc/types.ts#L68)*
