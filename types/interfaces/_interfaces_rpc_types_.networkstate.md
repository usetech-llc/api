...
\+ **new NetworkState**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[NetworkState](_interfaces_rpc_types_.networkstate.md)*
...
*Defined in [packages/types/src/interfaces/rpc/types.ts:77](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/rpc/types.ts#L77)*
