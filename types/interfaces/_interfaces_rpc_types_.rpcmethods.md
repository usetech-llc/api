...
\+ **new RpcMethods**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[RpcMethods](_interfaces_rpc_types_.rpcmethods.md)*
...
*Defined in [packages/types/src/interfaces/rpc/types.ts:99](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/rpc/types.ts#L99)*
...
*Defined in [packages/types/src/interfaces/rpc/types.ts:97](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/rpc/types.ts#L97)*
