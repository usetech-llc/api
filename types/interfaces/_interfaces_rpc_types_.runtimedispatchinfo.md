...
\+ **new RuntimeDispatchInfo**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[RuntimeDispatchInfo](_interfaces_rpc_types_.runtimedispatchinfo.md)*
...
*Defined in [packages/types/src/interfaces/rpc/types.ts:107](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/rpc/types.ts#L107)*
...
*Defined in [packages/types/src/interfaces/rpc/types.ts:109](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/rpc/types.ts#L109)*
...
*Defined in [packages/types/src/interfaces/rpc/types.ts:105](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/rpc/types.ts#L105)*
