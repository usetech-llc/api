...
\+ **new StorageChangeSet**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[StorageChangeSet](_interfaces_rpc_types_.storagechangeset.md)*
...
*Defined in [packages/types/src/interfaces/rpc/types.ts:134](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/rpc/types.ts#L134)*
...
*Defined in [packages/types/src/interfaces/rpc/types.ts:136](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/rpc/types.ts#L136)*
