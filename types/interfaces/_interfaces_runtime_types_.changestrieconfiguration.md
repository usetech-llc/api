...
\+ **new ChangesTrieConfiguration**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[ChangesTrieConfiguration](_interfaces_runtime_types_.changestrieconfiguration.md)*
...
*Defined in [packages/types/src/interfaces/runtime/types.ts:41](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/runtime/types.ts#L41)*
...
*Defined in [packages/types/src/interfaces/runtime/types.ts:43](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/runtime/types.ts#L43)*
