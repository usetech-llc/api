...
\+ **new DispatchInfo**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[DispatchInfo](_interfaces_runtime_types_.dispatchinfo.md)*
...
*Defined in [packages/types/src/interfaces/runtime/types.ts:71](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/runtime/types.ts#L71)*
...
*Defined in [packages/types/src/interfaces/runtime/types.ts:73](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/runtime/types.ts#L73)*
...
*Defined in [packages/types/src/interfaces/runtime/types.ts:69](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/runtime/types.ts#L69)*
