...
\+ **new DispatchInfoTo190**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[DispatchInfoTo190](_interfaces_runtime_types_.dispatchinfoto190.md)*
...
*Defined in [packages/types/src/interfaces/runtime/types.ts:81](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/runtime/types.ts#L81)*
...
*Defined in [packages/types/src/interfaces/runtime/types.ts:79](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/runtime/types.ts#L79)*
