[Polkadot JS API](../README.md) › [Globals](../globals.md) › ["interfaces/runtime/types"](../modules/_interfaces_runtime_types_.md) › [EcdsaSignature](_interfaces_runtime_types_.ecdsasignature.md)
...
* [BYTES_PER_ELEMENT](_interfaces_runtime_types_.ecdsasignature.md#bytes_per_element)
* [Uint8Array](_interfaces_runtime_types_.ecdsasignature.md#uint8array)
* [[Symbol.toStringTag]](_interfaces_runtime_types_.ecdsasignature.md#[symbol.tostringtag])
* [buffer](_interfaces_runtime_types_.ecdsasignature.md#buffer)
* [byteLength](_interfaces_runtime_types_.ecdsasignature.md#bytelength)
* [byteOffset](_interfaces_runtime_types_.ecdsasignature.md#byteoffset)
* [encodedLength](_interfaces_runtime_types_.ecdsasignature.md#encodedlength)
* [hash](_interfaces_runtime_types_.ecdsasignature.md#hash)
* [isEmpty](_interfaces_runtime_types_.ecdsasignature.md#isempty)
* [length](_interfaces_runtime_types_.ecdsasignature.md#length)
* [registry](_interfaces_runtime_types_.ecdsasignature.md#registry)

### Methods

* [[Symbol.iterator]](_interfaces_runtime_types_.ecdsasignature.md#[symbol.iterator])
* [copyWithin](_interfaces_runtime_types_.ecdsasignature.md#copywithin)
* [entries](_interfaces_runtime_types_.ecdsasignature.md#entries)
* [eq](_interfaces_runtime_types_.ecdsasignature.md#eq)
* [every](_interfaces_runtime_types_.ecdsasignature.md#every)
* [fill](_interfaces_runtime_types_.ecdsasignature.md#fill)
* [filter](_interfaces_runtime_types_.ecdsasignature.md#filter)
* [find](_interfaces_runtime_types_.ecdsasignature.md#find)
* [findIndex](_interfaces_runtime_types_.ecdsasignature.md#findindex)
* [forEach](_interfaces_runtime_types_.ecdsasignature.md#foreach)
* [includes](_interfaces_runtime_types_.ecdsasignature.md#includes)
* [indexOf](_interfaces_runtime_types_.ecdsasignature.md#indexof)
* [join](_interfaces_runtime_types_.ecdsasignature.md#join)
* [keys](_interfaces_runtime_types_.ecdsasignature.md#keys)
* [lastIndexOf](_interfaces_runtime_types_.ecdsasignature.md#lastindexof)
* [map](_interfaces_runtime_types_.ecdsasignature.md#map)
* [reduce](_interfaces_runtime_types_.ecdsasignature.md#reduce)
* [reduceRight](_interfaces_runtime_types_.ecdsasignature.md#reduceright)
* [reverse](_interfaces_runtime_types_.ecdsasignature.md#reverse)
* [set](_interfaces_runtime_types_.ecdsasignature.md#set)
* [slice](_interfaces_runtime_types_.ecdsasignature.md#slice)
* [some](_interfaces_runtime_types_.ecdsasignature.md#some)
* [sort](_interfaces_runtime_types_.ecdsasignature.md#sort)
* [subarray](_interfaces_runtime_types_.ecdsasignature.md#subarray)
* [toHex](_interfaces_runtime_types_.ecdsasignature.md#tohex)
* [toJSON](_interfaces_runtime_types_.ecdsasignature.md#tojson)
* [toLocaleString](_interfaces_runtime_types_.ecdsasignature.md#tolocalestring)
* [toRawType](_interfaces_runtime_types_.ecdsasignature.md#torawtype)
* [toString](_interfaces_runtime_types_.ecdsasignature.md#tostring)
* [toU8a](_interfaces_runtime_types_.ecdsasignature.md#tou8a)
* [values](_interfaces_runtime_types_.ecdsasignature.md#values)
...
*Defined in [packages/types/src/types.ts:75](https://github.com/polkadot-js/api/blob/7ac3043f83/packages/types/src/types.ts#L75)*
...
*Defined in [packages/types/src/types.ts:80](https://github.com/polkadot-js/api/blob/7ac3043f83/packages/types/src/types.ts#L80)*
...
*Defined in [packages/types/src/types.ts:85](https://github.com/polkadot-js/api/blob/7ac3043f83/packages/types/src/types.ts#L85)*
...
*Defined in [packages/types/src/types.ts:90](https://github.com/polkadot-js/api/blob/7ac3043f83/packages/types/src/types.ts#L90)*
...
*Defined in [packages/types/src/types.ts:95](https://github.com/polkadot-js/api/blob/7ac3043f83/packages/types/src/types.ts#L95)*
...
*Defined in [packages/types/src/types.ts:100](https://github.com/polkadot-js/api/blob/7ac3043f83/packages/types/src/types.ts#L100)*
...
*Defined in [packages/types/src/types.ts:105](https://github.com/polkadot-js/api/blob/7ac3043f83/packages/types/src/types.ts#L105)*
...
*Defined in [packages/types/src/types.ts:110](https://github.com/polkadot-js/api/blob/7ac3043f83/packages/types/src/types.ts#L110)*
...
*Defined in [packages/types/src/types.ts:121](https://github.com/polkadot-js/api/blob/7ac3043f83/packages/types/src/types.ts#L121)*
