...
* [size](_interfaces_runtime_types_.extrinsicpayloadv2.md#size)
...
* [clear](_interfaces_runtime_types_.extrinsicpayloadv2.md#clear)
* [delete](_interfaces_runtime_types_.extrinsicpayloadv2.md#delete)
* [eq](_interfaces_runtime_types_.extrinsicpayloadv2.md#eq)
* [forEach](_interfaces_runtime_types_.extrinsicpayloadv2.md#foreach)
...
* [has](_interfaces_runtime_types_.extrinsicpayloadv2.md#has)
* [set](_interfaces_runtime_types_.extrinsicpayloadv2.md#set)
...
\+ **new ExtrinsicPayloadV2**(`registry`: [Registry](_types_.registry.md), `value?`: [ExtrinsicPayloadValue](_types_.extrinsicpayloadvalue.md) | [Uint8Array](../classes/_codec_raw_.raw.md#static-uint8array) | string): *[ExtrinsicPayloadV2](_interfaces_runtime_types_.extrinsicpayloadv2.md)*

*Inherited from [ExtrinsicPayloadV2](_interfaces_runtime_types_.extrinsicpayloadv2.md).[constructor](_interfaces_runtime_types_.extrinsicpayloadv2.md#constructor)*

*Overrides [Struct](../classes/_codec_struct_.struct.md).[constructor](../classes/_codec_struct_.struct.md#constructor)*

*Defined in [packages/types/src/primitive/Extrinsic/v2/ExtrinsicPayload.ts:42](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Extrinsic/v2/ExtrinsicPayload.ts#L42)*
...
*Inherited from [ExtrinsicPayloadV2](_interfaces_runtime_types_.extrinsicpayloadv2.md).[blockHash](_interfaces_runtime_types_.extrinsicpayloadv2.md#blockhash)*

*Defined in [packages/types/src/primitive/Extrinsic/v2/ExtrinsicPayload.ts:50](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Extrinsic/v2/ExtrinsicPayload.ts#L50)*
...
*Inherited from [ExtrinsicPayloadV2](_interfaces_runtime_types_.extrinsicpayloadv2.md).[era](_interfaces_runtime_types_.extrinsicpayloadv2.md#era)*

*Defined in [packages/types/src/primitive/Extrinsic/v2/ExtrinsicPayload.ts:57](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Extrinsic/v2/ExtrinsicPayload.ts#L57)*
...
*Inherited from [ExtrinsicPayloadV2](_interfaces_runtime_types_.extrinsicpayloadv2.md).[method](_interfaces_runtime_types_.extrinsicpayloadv2.md#method)*

*Defined in [packages/types/src/primitive/Extrinsic/v2/ExtrinsicPayload.ts:64](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Extrinsic/v2/ExtrinsicPayload.ts#L64)*
...
*Inherited from [ExtrinsicPayloadV2](_interfaces_runtime_types_.extrinsicpayloadv2.md).[nonce](_interfaces_runtime_types_.extrinsicpayloadv2.md#nonce)*

*Defined in [packages/types/src/primitive/Extrinsic/v2/ExtrinsicPayload.ts:71](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Extrinsic/v2/ExtrinsicPayload.ts#L71)*
...
*Inherited from [ExtrinsicPayloadV2](_interfaces_runtime_types_.extrinsicpayloadv2.md).[tip](_interfaces_runtime_types_.extrinsicpayloadv2.md#tip)*

*Defined in [packages/types/src/primitive/Extrinsic/v2/ExtrinsicPayload.ts:78](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Extrinsic/v2/ExtrinsicPayload.ts#L78)*
...
*Inherited from [ExtrinsicPayloadV2](_interfaces_runtime_types_.extrinsicpayloadv2.md).[sign](_interfaces_runtime_types_.extrinsicpayloadv2.md#sign)*

*Defined in [packages/types/src/primitive/Extrinsic/v2/ExtrinsicPayload.ts:85](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Extrinsic/v2/ExtrinsicPayload.ts#L85)*
