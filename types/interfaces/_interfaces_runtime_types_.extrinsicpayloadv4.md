...
* [size](_interfaces_runtime_types_.extrinsicpayloadv4.md#size)
...
* [clear](_interfaces_runtime_types_.extrinsicpayloadv4.md#clear)
* [delete](_interfaces_runtime_types_.extrinsicpayloadv4.md#delete)
* [eq](_interfaces_runtime_types_.extrinsicpayloadv4.md#eq)
* [forEach](_interfaces_runtime_types_.extrinsicpayloadv4.md#foreach)
...
* [has](_interfaces_runtime_types_.extrinsicpayloadv4.md#has)
* [set](_interfaces_runtime_types_.extrinsicpayloadv4.md#set)
...
\+ **new ExtrinsicPayloadV4**(`registry`: [Registry](_types_.registry.md), `value?`: [ExtrinsicPayloadValue](_types_.extrinsicpayloadvalue.md) | [Uint8Array](../classes/_codec_raw_.raw.md#static-uint8array) | string): *[ExtrinsicPayloadV4](_interfaces_runtime_types_.extrinsicpayloadv4.md)*

*Inherited from [ExtrinsicPayloadV4](_interfaces_runtime_types_.extrinsicpayloadv4.md).[constructor](_interfaces_runtime_types_.extrinsicpayloadv4.md#constructor)*

*Overrides [Struct](../classes/_codec_struct_.struct.md).[constructor](../classes/_codec_struct_.struct.md#constructor)*

*Defined in [packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts:21](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts#L21)*
...
`value?` | [ExtrinsicPayloadValue](_types_.extrinsicpayloadvalue.md) &#124; [Uint8Array](../classes/_codec_raw_.raw.md#static-uint8array) &#124; string |
...
*Inherited from [ExtrinsicPayloadV4](_interfaces_runtime_types_.extrinsicpayloadv4.md).[blockHash](_interfaces_runtime_types_.extrinsicpayloadv4.md#blockhash)*

*Defined in [packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts:29](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts#L29)*
...
*Inherited from [ExtrinsicPayloadV4](_interfaces_runtime_types_.extrinsicpayloadv4.md).[era](_interfaces_runtime_types_.extrinsicpayloadv4.md#era)*

*Defined in [packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts:36](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts#L36)*
...
*Inherited from [ExtrinsicPayloadV4](_interfaces_runtime_types_.extrinsicpayloadv4.md).[genesisHash](_interfaces_runtime_types_.extrinsicpayloadv4.md#genesishash)*

*Defined in [packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts:43](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts#L43)*
...
*Inherited from [ExtrinsicPayloadV4](_interfaces_runtime_types_.extrinsicpayloadv4.md).[method](_interfaces_runtime_types_.extrinsicpayloadv4.md#method)*

*Defined in [packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts:50](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts#L50)*
...
*Inherited from [ExtrinsicPayloadV4](_interfaces_runtime_types_.extrinsicpayloadv4.md).[nonce](_interfaces_runtime_types_.extrinsicpayloadv4.md#nonce)*

*Defined in [packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts:57](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts#L57)*
...
*Inherited from [ExtrinsicPayloadV4](_interfaces_runtime_types_.extrinsicpayloadv4.md).[specVersion](_interfaces_runtime_types_.extrinsicpayloadv4.md#specversion)*

*Defined in [packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts:64](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts#L64)*
...
*Inherited from [ExtrinsicPayloadV4](_interfaces_runtime_types_.extrinsicpayloadv4.md).[tip](_interfaces_runtime_types_.extrinsicpayloadv4.md#tip)*

*Defined in [packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts:71](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts#L71)*
...
▸ **sign**(`signerPair`: [IKeyringPair](_types_.ikeyringpair.md)): *[Uint8Array](../classes/_codec_raw_.raw.md#static-uint8array)*

*Inherited from [ExtrinsicPayloadV4](_interfaces_runtime_types_.extrinsicpayloadv4.md).[sign](_interfaces_runtime_types_.extrinsicpayloadv4.md#sign)*

*Defined in [packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts:78](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v4/ExtrinsicPayload.ts#L78)*
