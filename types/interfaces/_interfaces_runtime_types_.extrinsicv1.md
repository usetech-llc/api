...
* [size](_interfaces_runtime_types_.extrinsicv1.md#size)
...
* [clear](_interfaces_runtime_types_.extrinsicv1.md#clear)
* [delete](_interfaces_runtime_types_.extrinsicv1.md#delete)
* [eq](_interfaces_runtime_types_.extrinsicv1.md#eq)
* [forEach](_interfaces_runtime_types_.extrinsicv1.md#foreach)
* [get](_interfaces_runtime_types_.extrinsicv1.md#get)
* [getAtIndex](_interfaces_runtime_types_.extrinsicv1.md#getatindex)
* [has](_interfaces_runtime_types_.extrinsicv1.md#has)
* [set](_interfaces_runtime_types_.extrinsicv1.md#set)
* [sign](_interfaces_runtime_types_.extrinsicv1.md#sign)
* [signFake](_interfaces_runtime_types_.extrinsicv1.md#signfake)
...
\+ **new ExtrinsicV1**(`registry`: [Registry](_types_.registry.md), `value?`: [Uint8Array](../classes/_codec_raw_.raw.md#static-uint8array) | [ExtrinsicValueV1](_primitive_extrinsic_v1_extrinsic_.extrinsicvaluev1.md), `__namedParameters`: object): *[ExtrinsicV1](_interfaces_runtime_types_.extrinsicv1.md)*

*Inherited from [ExtrinsicV1](_interfaces_runtime_types_.extrinsicv1.md).[constructor](_interfaces_runtime_types_.extrinsicv1.md#constructor)*

*Overrides [Struct](../classes/_codec_struct_.struct.md).[constructor](../classes/_codec_struct_.struct.md#constructor)*

*Defined in [packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts:27](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts#L27)*

**Parameters:**

▪ **registry**: *[Registry](_types_.registry.md)*

▪`Optional`  **value**: *[Uint8Array](../classes/_codec_raw_.raw.md#static-uint8array) | [ExtrinsicValueV1](_primitive_extrinsic_v1_extrinsic_.extrinsicvaluev1.md)*
...
*Inherited from [ExtrinsicV1](_interfaces_runtime_types_.extrinsicv1.md).[encodedLength](_interfaces_runtime_types_.extrinsicv1.md#encodedlength)*

*Overrides [Struct](../classes/_codec_struct_.struct.md).[encodedLength](../classes/_codec_struct_.struct.md#encodedlength)*

*Defined in [packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts:57](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts#L57)*
...
*Inherited from [ExtrinsicV1](_interfaces_runtime_types_.extrinsicv1.md).[method](_interfaces_runtime_types_.extrinsicv1.md#method)*

*Defined in [packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts:64](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts#L64)*
...
*Inherited from [ExtrinsicV1](_interfaces_runtime_types_.extrinsicv1.md).[signature](_interfaces_runtime_types_.extrinsicv1.md#signature)*

*Defined in [packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts:71](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts#L71)*
...
*Inherited from [ExtrinsicV1](_interfaces_runtime_types_.extrinsicv1.md).[version](_interfaces_runtime_types_.extrinsicv1.md#version)*

*Defined in [packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts:78](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts#L78)*
...
▸ **addSignature**(`signer`: [Address](_interfaces_runtime_types_.address.md) | [Uint8Array](../classes/_codec_raw_.raw.md#static-uint8array) | string, `signature`: [Uint8Array](../classes/_codec_raw_.raw.md#static-uint8array) | string, `payload`: [ExtrinsicPayloadValue](_types_.extrinsicpayloadvalue.md) | [Uint8Array](../classes/_codec_raw_.raw.md#static-uint8array) | string): *[ExtrinsicV1](../classes/_primitive_extrinsic_v1_extrinsic_.extrinsicv1.md)*

*Inherited from [ExtrinsicV1](_interfaces_runtime_types_.extrinsicv1.md).[addSignature](_interfaces_runtime_types_.extrinsicv1.md#addsignature)*

*Defined in [packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts:85](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts#L85)*
...
*Inherited from [ExtrinsicV1](_interfaces_runtime_types_.extrinsicv1.md).[sign](_interfaces_runtime_types_.extrinsicv1.md#sign)*

*Defined in [packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts:94](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts#L94)*
...
▸ **signFake**(`signer`: [Address](_interfaces_runtime_types_.address.md) | [Uint8Array](../classes/_codec_raw_.raw.md#static-uint8array) | string, `options`: [SignatureOptions](_types_.signatureoptions.md)): *[ExtrinsicV1](../classes/_primitive_extrinsic_v1_extrinsic_.extrinsicv1.md)*

*Inherited from [ExtrinsicV1](_interfaces_runtime_types_.extrinsicv1.md).[signFake](_interfaces_runtime_types_.extrinsicv1.md#signfake)*

*Defined in [packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts:103](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts#L103)*
...
▸ **decodeExtrinsic**(`registry`: [Registry](_types_.registry.md), `value?`: [Uint8Array](../classes/_codec_raw_.raw.md#static-uint8array) | [ExtrinsicValueV1](_primitive_extrinsic_v1_extrinsic_.extrinsicvaluev1.md), `isSigned`: boolean): *[ExtrinsicValueV1](_primitive_extrinsic_v1_extrinsic_.extrinsicvaluev1.md)*

*Inherited from [ExtrinsicV1](_interfaces_runtime_types_.extrinsicv1.md).[decodeExtrinsic](_interfaces_runtime_types_.extrinsicv1.md#static-decodeextrinsic)*

*Defined in [packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts:35](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/primitive/Extrinsic/v1/Extrinsic.ts#L35)*
...
------ | ------ | ------ |
`registry` | [Registry](_types_.registry.md) | - |
`value?` | [Uint8Array](../classes/_codec_raw_.raw.md#static-uint8array) &#124; [ExtrinsicValueV1](_primitive_extrinsic_v1_extrinsic_.extrinsicvaluev1.md) | - |
