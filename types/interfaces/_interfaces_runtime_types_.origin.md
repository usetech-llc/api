...
*Inherited from [Origin](_interfaces_runtime_types_.origin.md).[constructor](_interfaces_runtime_types_.origin.md#constructor)*

*Overrides [Null](../classes/_primitive_null_.null.md).[constructor](../classes/_primitive_null_.null.md#constructor)*

*Defined in [packages/types/src/primitive/Generic/Origin.ts:15](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/Generic/Origin.ts#L15)*
