...
*Inherited from [Percent](_interfaces_runtime_types_.percent.md).[constructor](_interfaces_runtime_types_.percent.md#constructor)*

*Overrides [UInt](../classes/_codec_uint_.uint.md).[constructor](../classes/_codec_uint_.uint.md#constructor)*

*Defined in [packages/types/src/primitive/U8.ts:14](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/primitive/U8.ts#L14)*
