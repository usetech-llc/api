...
\+ **new SignedBlock**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[SignedBlock](_interfaces_runtime_types_.signedblock.md)*
...
*Defined in [packages/types/src/interfaces/runtime/types.ts:222](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/runtime/types.ts#L222)*
...
*Defined in [packages/types/src/interfaces/runtime/types.ts:224](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/runtime/types.ts#L224)*
