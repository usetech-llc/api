...
\+ **new Bid**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[Bid](_interfaces_society_types_.bid.md)*
...
*Defined in [packages/types/src/interfaces/society/types.ts:14](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/society/types.ts#L14)*
...
*Defined in [packages/types/src/interfaces/society/types.ts:16](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/society/types.ts#L16)*
...
*Defined in [packages/types/src/interfaces/society/types.ts:12](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/society/types.ts#L12)*
