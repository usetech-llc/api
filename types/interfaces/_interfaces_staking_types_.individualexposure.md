...
\+ **new IndividualExposure**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[IndividualExposure](_interfaces_staking_types_.individualexposure.md)*
...
*Defined in [packages/types/src/interfaces/staking/types.ts:55](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/staking/types.ts#L55)*
...
*Defined in [packages/types/src/interfaces/staking/types.ts:53](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/staking/types.ts#L53)*
