...
\+ **new Nominations**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[Nominations](_interfaces_staking_types_.nominations.md)*
...
*Defined in [packages/types/src/interfaces/staking/types.ts:66](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/staking/types.ts#L66)*
...
*Defined in [packages/types/src/interfaces/staking/types.ts:68](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/staking/types.ts#L68)*
...
*Defined in [packages/types/src/interfaces/staking/types.ts:64](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/staking/types.ts#L64)*
