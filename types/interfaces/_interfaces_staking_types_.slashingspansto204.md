...
\+ **new SlashingSpansTo204**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[SlashingSpansTo204](_interfaces_staking_types_.slashingspansto204.md)*
...
*Defined in [packages/types/src/interfaces/staking/types.ts:101](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/staking/types.ts#L101)*
...
*Defined in [packages/types/src/interfaces/staking/types.ts:103](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/staking/types.ts#L103)*
...
*Defined in [packages/types/src/interfaces/staking/types.ts:99](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/staking/types.ts#L99)*
