...
\+ **new SpanRecord**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[SpanRecord](_interfaces_staking_types_.spanrecord.md)*
...
*Defined in [packages/types/src/interfaces/staking/types.ts:124](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/staking/types.ts#L124)*
...
*Defined in [packages/types/src/interfaces/staking/types.ts:122](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/staking/types.ts#L122)*
