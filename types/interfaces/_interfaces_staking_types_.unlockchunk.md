...
\+ **new UnlockChunk**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[UnlockChunk](_interfaces_staking_types_.unlockchunk.md)*
...
*Defined in [packages/types/src/interfaces/staking/types.ts:161](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/staking/types.ts#L161)*
...
*Defined in [packages/types/src/interfaces/staking/types.ts:159](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/staking/types.ts#L159)*
