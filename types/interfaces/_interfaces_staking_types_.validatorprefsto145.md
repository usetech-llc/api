...
\+ **new ValidatorPrefsTo145**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[ValidatorPrefsTo145](_interfaces_staking_types_.validatorprefsto145.md)*
...
*Defined in [packages/types/src/interfaces/staking/types.ts:173](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/staking/types.ts#L173)*
...
*Defined in [packages/types/src/interfaces/staking/types.ts:175](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/staking/types.ts#L175)*
