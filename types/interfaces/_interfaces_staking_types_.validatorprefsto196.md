...
\+ **new ValidatorPrefsTo196**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[ValidatorPrefsTo196](_interfaces_staking_types_.validatorprefsto196.md)*
...
*Defined in [packages/types/src/interfaces/staking/types.ts:181](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/staking/types.ts#L181)*
