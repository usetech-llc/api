...
\+ **new DispatchErrorModule**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[DispatchErrorModule](_interfaces_system_types_.dispatcherrormodule.md)*
...
*Defined in [packages/types/src/interfaces/system/types.ts:31](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/system/types.ts#L31)*
...
*Defined in [packages/types/src/interfaces/system/types.ts:29](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/system/types.ts#L29)*
