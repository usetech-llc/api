...
\+ **new DispatchErrorTo198**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[DispatchErrorTo198](_interfaces_system_types_.dispatcherrorto198.md)*
...
*Defined in [packages/types/src/interfaces/system/types.ts:39](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/system/types.ts#L39)*
...
*Defined in [packages/types/src/interfaces/system/types.ts:37](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/system/types.ts#L37)*
