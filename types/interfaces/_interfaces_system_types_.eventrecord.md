...
\+ **new EventRecord**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[EventRecord](_interfaces_system_types_.eventrecord.md)*
...
*Defined in [packages/types/src/interfaces/system/types.ts:83](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/system/types.ts#L83)*
...
*Defined in [packages/types/src/interfaces/system/types.ts:81](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/system/types.ts#L81)*
...
*Defined in [packages/types/src/interfaces/system/types.ts:85](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/system/types.ts#L85)*
