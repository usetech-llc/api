...
\+ **new EventRecordTo76**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[EventRecordTo76](_interfaces_system_types_.eventrecordto76.md)*
...
*Defined in [packages/types/src/interfaces/system/types.ts:93](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/system/types.ts#L93)*
...
*Defined in [packages/types/src/interfaces/system/types.ts:91](https://github.com/polkadot-js/api/blob/3db15e73a5/packages/types/src/interfaces/system/types.ts#L91)*
