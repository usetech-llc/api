...
\+ **new Timepoint**(`registry`: [Registry](_types_.registry.md), `Types`: S, `value`: V | [Map](../classes/_codec_struct_.struct.md#static-map)‹any, any› | any[] | string, `jsonMap`: [Map](../classes/_codec_struct_.struct.md#static-map)‹keyof S, string›): *[Timepoint](_interfaces_utility_types_.timepoint.md)*
...
*Defined in [packages/types/src/interfaces/utility/types.ts:23](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/utility/types.ts#L23)*
...
*Defined in [packages/types/src/interfaces/utility/types.ts:25](https://github.com/polkadot-js/api/blob/854a520517/packages/types/src/interfaces/utility/types.ts#L25)*
