...
*Defined in [packages/types/src/codec/create/createClass.ts:24](https://github.com/polkadot-js/api/blob/7de647ec0b/packages/types/src/codec/create/createClass.ts#L24)*
...
*Defined in [packages/types/src/codec/create/createClass.ts:19](https://github.com/polkadot-js/api/blob/7de647ec0b/packages/types/src/codec/create/createClass.ts#L19)*
...
*Defined in [packages/types/src/codec/create/createClass.ts:12](https://github.com/polkadot-js/api/blob/7de647ec0b/packages/types/src/codec/create/createClass.ts#L12)*
